...
class HostExtend(models.Model, ModelMixin):
    ...
    location = models.CharField(max_length=20, default=0.0)
    private_ip_address = models.CharField(max_length=255, default=0.0)
    public_ip_address = models.CharField(max_length=255, default=0.0)
