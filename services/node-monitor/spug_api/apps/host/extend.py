...
from apps.host.utils import check_os_type, fetch_host_extend, fetch_location
import json
...
class ExtendView(View):
    ...
    def post(self, request):
        ...
        if error is None:
            ...
            geoInfo = fetch_location(form.public_ip_address)
            if 'Error' not in geoInfo:
                form['location'] = geoInfo.location
                form['longitude'] = geoInfo.longitude
                form['latitude'] = geoInfo.latitude
