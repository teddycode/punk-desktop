...
class ExecConfig(models.Model, ModelMixin):
    name = models.CharField(max_length=50)
    version_num = models.CharField(max_length=50)
    body = models.TextField()
    interpreter = models.CharField(max_length=20, default='json')
    host_ids = models.TextField(default='[]')
    desc = models.CharField(max_length=255, null=True)
    created_at = models.CharField(max_length=20, default=human_datetime)
    created_by = models.ForeignKey(User, models.PROTECT, related_name='+')
    ...
    class Meta:
        db_table = 'exec_configs'
        ordering = ('-id',)

class Execrelateconfig(models.Model, ModelMixin):
    app_id = models.IntegerField()
    config_id = models.IntegerField()

class Execrelatetemplate(models.Model, ModelMixin):
    app_id = models.IntegerField()
