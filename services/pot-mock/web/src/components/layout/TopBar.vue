<template>
  ...
  <div class="stat-item-large"></div>
    ...
    <a-tooltip title="节点连接配置">
      <a-button class="connection-button" shape="circle" @click="configVisible = true">
        <template #icon>
          <ApiOutlined />
        </template>
      </a-button>
    ...
    <ConnectionConfigModal v-model:visible="configVisible" />
  </div>
</template>
...
import ConnectionConfigModal from "@/components/layout/ConnectionConfigModal.vue";
