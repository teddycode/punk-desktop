...
const sessionRestore = {
  adapter: {},
  currentSpace: {},
  save: async function (forceSave = false, sync = true) {
    //默认关闭强制保存
    ...
    if (typeof currentSpace.space.data === 'string') currentSpace.space.data = JSON.parse(currentSpace.space.data);
  ...
  initialize: async function () {
    ...
    if (currentSpace.spaceType === 'cloud') {
      ...
      if (space) space.userInfo = currentSpace.userInfo;
    }
