...
const webviews = {
  ...
  viewMargins: [
    document.getElementById('toolbar').hidden ? 0 : document.getElementById('third-toolbar').hidden ? 40 : 80,
    0,
    0,
    45,
  ...
  autoAdjustMargin: function () {
    ...
    if (window.$toolbar.layoutMod === 'min') {
      ...
      top = document.getElementById('toolbar').hidden ? 0 : document.getElementById('third-toolbar').hidden ? 40 : 80;
      left = window.sideBar.mod === 'close' ? 45 : window.sideBar.mod === 'open' ? 145 : 45;
    }

    const currentMargins = [top, 0, 0, left];
