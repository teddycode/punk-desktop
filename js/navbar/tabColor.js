  ...
  for (let i = 0; i < textElements.length; i++) {
    ...
    if (textElements[i].id === 'switch-task-button') {
      textElements[i].innerHTML =
        ` <svg width="18px" height="18px" viewBox="0 0 104 104" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
const tabColor = {
  ...
  initialize: function () {
    ...
    webviews.bindEvent(
      ...
      function (tabId, url, isInPlace, isMainFrame, frameProcessId, frameRoutingId) {
        if (isMainFrame) {
          tabs.update(tabId, {
            backgroundColor: {
              color: '#DFDFE3',
