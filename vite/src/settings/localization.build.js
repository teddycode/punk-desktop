var languages = {
  'ar': {
    'name': 'Arabic', 'identifier': 'ar', 'rtl': true, 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': '<a href="https://github.com/minbrowser/min" target="_blank">هنا</a> ادا ظهر لك "هذا المشكل مرة اخرى.قم بفتح مشكلة ' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'إرسال إحصائيات المستخدم - <a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">معرفة المزيد</a>' },
    ...
    'name': 'Bulgarian', 'identifier': 'bg', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Ако тази грешка продължи да се появява, моля отворете нов проблем <a href="https://github.com/minbrowser/min" target="_blank">тук</a>.' },
      ...
      'settingsUserscriptsExplanation': { 'unsafeHTML': 'Потребителските скриптове Ви позволяват да промените поведението на уеб сайтове - <a href="https://github.com/minbrowser/min/wiki/userscripts">научете повече</a>.' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Първо, <a id=\'password-manager-setup-link\'></a> и го извлечете за Вашата система.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Изтеглете <a id=\'password-manager-setup-link-installer\'></a> и плъзнете файла в полето отдолу:' },
    ...
    'name': 'বাংলা', 'identifier': 'bn', 'translations': {
      ...
      'multipleInstancesErrorMessage': 'একটি ত্রুটি ঘটেছে. অন্য কোনও খোলা দৃষ্টান্ত বন্ধ করুন এবং Min পুনরায় আরম্ভ করুন।',
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'যদি এই ত্রুটিটি ঘটতে থাকে তবে দয়া করে একটি নতুন সমস্যা <a href="https://github.com/minbrowser/min" target="_blank"> এখানে </a> খুলুন।' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'এখনও অবধি, Min <strong></strong> বিজ্ঞাপন এবং ট্র্যাকারদের অবরুদ্ধ করেছে' },
      'settingsCustomBangs': null,
      'settingsCustomBangsAdd': null,
      'settingsCustomBangsPhrase': null,
      'settingsCustomBangsSnippet': null,
    ...
    'name': 'Česky', 'identifier': 'cs', 'translations': {
      ...
      'sslTimeErrorMessage': 'Prohlížeč Min nemůže s touto stránkou navázat zabezpečené spojení. Prosím zkontrolujte, zda máte v počítači správně nastavený čas.',
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Pokud se tato chyba opakuje, založte prosím nový problém <a href="https://github.com/minbrowser/min" target="_blank">zde</a>.' },
      ...
      'settingsUserscriptsExplanation': { 'unsafeHTML': 'Uživatelské skripty umožňují upravit chování webových stránek - <a href="https://github.com/minbrowser/min/wiki/userscripts">více informací</a>.' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Nejprve <a id=\'password-manager-setup-link\'></a> a rozbalte archiv pro váš systém.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Stáhněte <a id=\'password-manager-setup-link-installer\'></a> a přetáhněte soubor do pole níže:' },
    ...
    'name': 'Deutsch', 'identifier': 'de', 'translations': {
      ...
      'sslTimeErrorMessage': 'Min konnte keine sichere Verbindung mit dieser Webseite aufbauen. Bitte stellen Sie sicher, dass Ihre Computeruhr korrekt eingestellt ist.',
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Falls dieser Fehler wiederholt auftritt, bitte <a href="https://github.com/minbrowser/min" target="_blank">hier</a> eine neue Fehlermeldung eröffnen.' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'Bis jetzt hat Min <strong></strong> Werbeanzeigen und Aktivitätsverfolgungen blockiert.' },
      ...
      'settingsUserscriptsExplanation': { 'unsafeHTML': 'Benutzerdefinierte Skripte erlauben es das Verhalten von Webseiten zu modifizieren - <a href="https://github.com/minbrowser/min/wiki/userscripts"> mehr dazu.</a>.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Sende anonyme Nutzungsstatistiken (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Mehr Infos</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Als erstes, <a id=\'password-manager-setup-link\'></a> und extrahiere es auf dein System.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Lade <a id=\'password-manager-setup-link-installer\'></a> herunter und ziehe die Datei unten in die Box:' },
    ...
    'name': 'English (United States)', 'identifier': 'en-US', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'If this error continues to occur, please open a new issue <a href="https://github.com/minbrowser/min" target="_blank">here</a>.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Send usage statistics (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">More info</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'First, <a id=\'password-manager-setup-link\'></a> and extract it for your system.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Download <a id=\'password-manager-setup-link-installer\'></a> and drag the file into the box below:' },
    ...
    'name': 'Spanish', 'identifier': 'es', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Si este error continúa, abra un nuevo reporte <a href="https://github.com/minbrowser/min" target="_blank">aquí</a>.' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'Hasta ahora, Min ha bloqueado <strong></strong> anuncios y rastreadores.' },
      ...
      'settingsUserscriptsExplanation': { 'unsafeHTML': 'Los userscripts te permiten modificar el comportamiento de los sitios web - <a href="https://github.com/minbrowser/min/wiki/userscripts">Más información</a>.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Enviar estadísticas de uso (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Más información</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Primero, <a id=\'password-manager-setup-link\'></a> y extráelo para tu sistema.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Descarga <a id=\'password-manager-setup-link-installer\'></a> y arrastra el archivo en el cuadro de abajo:' },
    ...
    'name': 'Persian', 'identifier': 'fa', 'rtl': true, 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'اگر این خطا همواره رخ می دهد لطفا یک تیکت جدید در <a href="https://github.com/minbrowser/min" target="_blank">اینجا</a> باز کنید.' },
    ...
    'name': 'Français', 'identifier': 'fr', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Si cette erreur continue à se produire, merci d\'ouvrir un ticket : <a href="https://github.com/minbrowser/min" target="_blank">ici</a>.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Envoyer des statistiques d\'utilisation - <a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">En savoir plus sur les statistiques envoyées (en anglais)</a>' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Premièrement, <a id=\'password-manager-setup-link\'></a> puis l\'extraire pour votre système.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Télécharger <a id=\'password-manager-setup-link-installer\'></a> puis glisser le fichier dans le cadre ci-dessous :' },
    ...
    'name': 'Croatian', 'identifier': 'hr', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Ako se ova pogreška i dalje događa, prijavite novi problem <a href="https://github.com/minbrowser/min" target="_blank">ovdje</a>.' },
      ...
      'settingsUserscriptsExplanation': { 'unsafeHTML': 'Korisničke skripte omogućuju vam izmjenu ponašanja web stranica - <a href="https://github.com/minbrowser/min/wiki/userscripts">Saznajte više</a>.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Pošaljite statistiku upotrebe (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Više informacija</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Prvo, <a id=\'password-manager-setup-link\'></a> i izdvojite ga za svoj sustav.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Preuzmi <a id=\'password-manager-setup-link-installer\'></a> i povucite datoteku u donji okvir:' },
    ...
    'name': 'Hungarian (Hungary)', 'identifier': 'hu', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Ha a probléma nem múlik el, <a href="https://github.com/minbrowser/min" target="_blank">itt nyisson</a> egy hibajelentést.' },
    ...
    'name': 'Italiano', 'identifier': 'it', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Se questo errore persiste, apri un nuovo issue <a href="https://github.com/minbrowser/min" target="_blank">qui</a>.' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'Fino ad ora, Min ha bloccato <strong></strong> pubblicità e tracciatori' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Invia statistiche di utilizzo (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Maggiori informazioni</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Prima, <a id=\'password-manager-setup-link\'></a> ed estrailo per il tuo sistema.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Scarica <a id=\'password-manager-setup-link-installer\'></a> e sposta il file nel box qui sotto:' },
    ...
    'name': '日本語', 'identifier': 'ja', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'もしこのエラーが立て続けに発生する場合は、<a href="https://github.com/minbrowser/min" target="_blank">こちら</a>から新しいissueを開いてください。' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'これまでのところ、Minは<strong></strong>の広告とトラッカーをブロックしています。' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': '使用統計を送信する (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">より詳しい情報</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': '最初に <a id=\'password-manager-setup-link\'></a> 、システムに展開します。' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': '<a id=\'password-manager-setup-link-installer\'></a>をダウンロードして、ファイルを下のボックスにドラッグします。' },
    ...
    'name': '한국어', 'identifier': 'ko', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': '오류가 계속 발생하면 <a href="https://github.com/minbrowser/min" target="_blank">문의</a> 바랍니다.' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': '지금까지 민(Min)은 <strong></strong> 광고 및 추적기를 차단했습니다.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': '사용량 현황 데이터 수집 사용 (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">자세히 보기</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': '우선, <a id=\'password-manager-setup-link\'></a>를 방문해 시스템에 내려받으세요.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': '<a id=\'password-manager-setup-link-installer\'></a> 설치 파일을 내려받고 아래 박스 안에 끌어다 놓습니다:' },
    ...
    'name': 'Lietuvių', 'identifier': 'lt', 'translations': {
      'addToDictionary': null,
      'pictureInPicture': null,
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Jei ši klaida atsiranda ir toliau, tuomet praneškite apie problemą <a href="https://github.com/minbrowser/min" target="_blank">čia</a>.' },
    ...
    'name': 'Polski', 'identifier': 'pl', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Jeśli błąd nadal występuje, otwórz nowy problem <a href="https://github.com/minbrowser/min" target="_blank">tutaj</a>.' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'Jak dotąd Min zablokował reklamy i moduły śledzące w ilości: <strong></strong>.' },
      ...
      'settingsUserscriptsExplanation': { 'unsafeHTML': 'Skrypty użytkownika pozwalają modyfikować zachowanie stron internetowych - <a href="https://github.com/minbrowser/min/wiki/userscripts">dowiedz się więcej</a>.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Wysyłaj statystyki użytkowania (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Więcej informacji</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Najpierw, <a id=\'password-manager-setup-link\'></a> i wypakuj go dla swojego systemu.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Pobierz <a id=\'password-manager-setup-link-installer\'></a> i przeciągnij plik do pola poniżej:' },
    ...
    'name': 'Português (Brasil)', 'identifier': 'pt-BR', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Se este erro continuar ocorrendo, por favor, abra um novo chamado <a href="https://github.com/minbrowser/min" target="_blank">aqui</a>.' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'Até agora, o Min bloqueou <strong> </strong> anúncios e rastreadores.' },
      'settingsCustomBangs': 'Bangs personalizados',
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Enviar estatísticas de uso (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Mais informações</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Primeiro, <a id=\'password-manager-setup-link\'></a> e extraia-o para o seu sistema.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Baixe <a id=\'password-manager-setup-link-installer\'></a> e arraste o arquivo para a caixa abaixo:' },
    ...
    'name': 'Portuguese (Portugal)', 'identifier': 'pt-PT', 'translations': {
      'addToDictionary': 'Adicionar ao dicionário',
      'pictureInPicture': 'Picture in Picture',
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Se este erro persistir, crie um relatório de erro <a href="https://github.com/minbrowser/min" target="_blank">aqui</a>.' },
      'settingsPreferencesHeading': 'Preferências',
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Enviar estatísticas de utilização (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Mais informação</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Primeiro, <a id=\'password-manager-setup-link\'></a> e extraia para o seu sistema.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Descarregue <a id=\'password-manager-setup-link-installer\'></a> e arraste o ficheiro para a caixa abaixo:' },
    ...
    'name': 'Русский', 'identifier': 'ru', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Если эта ошибка продолжает появляться, пожалуйста, сообщите о ней <a href="https://github.com/minbrowser/min" target="_blank">сюда</a>.' },
      ...
      'settingsBlockedRequestCount': { 'unsafeHTML': 'На данный момент Min заблокировал <strong></strong> объявлений и трекеров' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Отправлять статистику использования (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Подробнее</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Во-первых, <a id=\'password-manager-setup-link\'></a> и извлеките его для вашей системы.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Загрузите <a id= \'password-manager-setup-link-installer\'>< / a> и перетащите файл в поле ниже:' },
    ...
    'name': 'Turkish (Turkey)', 'identifier': 'tr', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Bu hata olmaya devam ederse, lütfen <a href="https://github.com/minbrowser/min" target="_blank">buradan</a> yeni bir sorun başlığı açın.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Kullanım Bilgilerini Gönder (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Daha Fazla Bilgi</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'İlk olarak, <a id=\'password-manager-setup-link\'></a> ve ve arşivden çıkartın.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': '<a id=\'password-manager-setup-link-installer\'></a> indirin ve dosyayı aşağıdaki kutucuğa sürükleyip bırakın:' },
    ...
    'name': 'Українська', 'identifier': 'uk', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Якщо ця помилка продовжує з\'являтися, будь ласка, повідомте про неї <a href="https://github.com/minbrowser/min" target="_blank">сюди</a>.' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': 'Надсилати статистику використання (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">Детальніше</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': 'Спочатку <a id=\'password-manager-setup-link\'></a> і розпакуйте його для Вашої системи.' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': 'Завантажте <a id=\'password-manager-setup-link-installer\'></a> і перетягніть файл у поле нижче:' },
    ...
    'name': 'Uzbek', 'identifier': 'uz', 'translations': {
      'addToDictionary': null,
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Agar bu muammo yuz berishni davom etsa, iltimos yangi masala oching <a href="https://github.com/minbrowser/min" target="_blank">here</a>.' },
      ...
      'settingsAutoplayToggle': null,
      'settingsOpenTabsInForegroundToggle': null,
      'settingsUserscriptsExplanation': { 'unsafeHTML': 'Foydalanuvchi skriptlari sahifa ishlashini o\'zgartirishga yordam beradi - <a href="https://github.com/minbrowser/min/wiki/userscripts">qo\'shimcha ma\'lumot</a>.' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': ' Birinchi, <a id=\'password-manager-setup-link\'></a> va o\'z tizimingizga chiqarib oling.' },
    ...
    'name': 'Tiếng Việt', 'identifier': 'vi', 'translations': {
      'addToDictionary': null,
      'pictureInPicture': null,
      ...
      'sslTimeErrorMessage': 'Min không có thể kết nối an toàn đến trang web này. Hãy kiểm tra đồng hồ máy tính của bạn bị đật đúng.',
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': 'Nếu lỗi này vẫn còn xảy ra, hãy tạo báo cáo về lỗi mới <a href="https://github.com/minbrowser/min" target="_blank">tại đây</a>.' },
    ...
    'name': '中文 (简体中文)', 'identifier': 'zh-CN', 'translations': {
      ...
      'sslTimeErrorMessage': '无法安全地连接到当前站点。您与此网站之间建立的连接不安全，点击继续访问设置此不安全站点为白名单，前往。',
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': '如果持续发生此错误，请在<a href="https://apps.vip" target="_blank">此处</a>报告错误信息。' },
      ...
      'settingsUserscriptsExplanation': { 'unsafeHTML': '自定义脚本允许您改变网站行为 - <a target="_blank" href="https://www.yuque.com/tswork/ngd5zk/zoxpq7">查看更多</a>.' },
      'settingsUserAgentToggle': '自定义浏览器User-Agent',
      'settingsUpdateNotificationsToggle': '自动检查更新',
      'settingsUsageStatisticsToggle': { 'unsafeHTML': '发送使用情况统计信息 (<a target="_blank" href="https://www.yuque.com/tswork/ngd5zk/bdvvgs">更多说明</a>)' },
      ...
      'passwordManagerSetupStep1': { 'unsafeHTML': '首先, 访问 <a id=\'password-manager-setup-link\'></a> 并解压到你的系统中。' },
      'passwordManagerInstallerSetup': { 'unsafeHTML': '下载 <a id=\'password-manager-setup-link-installer\'></a>，完成后将文件拖拽至下方。' },
      ...
      'translateTip': '当你翻译当前页面的时候，页面内容将被发送到服务器，我们不会存储你的翻译内容或者使用他们来识别你。请放心使用。',
    ...
    'name': '中文 (繁體中文)', 'identifier': 'zh-TW', 'translations': {
      ...
      'sessionRestoreErrorLinkInfo': { 'unsafeHTML': '如果持續發生此錯誤，請至<a href="https://github.com/minbrowser/min" target="_blank">此頁面</a>報告錯誤' },
      ...
      'settingsUsageStatisticsToggle': { 'unsafeHTML': '傳送使用統計資料 (<a href="https://github.com/minbrowser/min/blob/master/docs/statistics.md">更多資訊</a>)' },
      ...
      'passwordManagerInstallerSetup': { 'unsafeHTML': '下載 <a id=\'password-manager-setup-link-installer\'></a> 並將檔案拖曳至下方：' },
