  ...
  <a-config-provider :locale="locale">
    ...
    <div style="margin:auto;width: 1200px;box-shadow:0 0 16px rgba(0,0,0,0.32)">
      <div style="background:white">
        <a-tabs :destroyInactiveTabPane="false" v-model:activeKey="activeKey" type="card" tabPosition="left"
          style="height: 100vh; ">
          <template #leftExtra>
              ...
              <div class="setting-section" id="tracking-level-container">
                ...
                <div id="content-blocking-information" hidden>
                  <div>
                    ...
                    <textarea spellcheck="false" id="content-blocking-exceptions" style="width: 100%; max-width: 500px"
                      rows="1"></textarea>
                  </div>
                  <a id="customize-filters-link" target="_blank" href="https://www.yuque.com/tswork/ngd5zk/vch5wr"
                    data-string="settingsCustomizeFiltersLink"></a>
                </div>
              </div>
          ...
          <a-tab-pane :forceRender="true" key="DownloadSetting">
            ...
            <div class="settings-container">
              ...
              <div class="setting-section" style="display: flex;align-items: center">
                ...
                <a-input :disabled="true" v-model:value="savePath" style="width: 40%;margin-left: 15px"
              ...
              <div class="settings-container" v-for="itemGroup in settings.sidePanel.itemGroups">
                <div v-for="item in itemGroup.download">
                  ...
                  <span v-if="item.type === 'switch'">
                    <a-switch style="margin-bottom: 4px" @change="onChange($event)" size="small"
                      v-model:checked="downloadAuto" />
                  </span>
            ...
            <div class="settings-container" id="additional-settings-container">
              ...
              <div class="setting-section">
                ...
                <div style="margin-top: 5px">
                  <a-checkbox :disabled="this.platform !== 'win32'" @change="changeAskCloseExit"
                    v-model:checked="askCloseExit">每次关闭主窗体的时候都询问</a-checkbox>
                </div>
                <a-radio-group
                  style="margin-top: 10px;margin-bottom: 10px;background: #f1f1f1;padding: 10px;border-radius: 3px"
                  v-if="askCloseExit === false && this.platform === 'win32'" @change="changeCloseExit"
              ...
              <div class="setting-section" id="section-user-agent">
                ...
                <input type="text" id="input-user-agent" style="
          ...
          <a-tab-pane :forceRender="true" key="SearchEngine">
            ...
            <div class="settings-container" id="search-engine-settings-container">
              ...
              <div class="setting-section">
                ...
                <div class="settings-info-subheading" style="padding-top: 0.4em" data-string="settingsDDGExplanation">
                </div>
              </div>
            </div>
            ...
            <div class="settings-container" id="browser-tab-container">
              ...
              <div class="setting-section" id="tab-choose">
                ...
                <div class="setting-option">
                  ...
                  <input id="tab-text-input" type="text" placeholder="请输入" style="width: 100%; max-width: 300px" hidden />
                </div>
              </div>
            </div>
          ...
          <a-tab-pane :forceRender="true" key="Password">
            ...
            <div class="settings-container" id="password-autofill-container">
              ...
              <div class="setting-section">
                ...
                <div hidden v-if="currentPasswordManager.name !== 'file'"
                  ...
                  <div style="padding-left: 42px;">推荐使用<strong>磐古轻密码</strong>管理您的密码，可一键迁移当前浏览器密码至轻应用。
                    <a-button @click="setPasswordManager('file')" type="primary" size="small"
                      style="margin-top: 10px">点击更改</a-button>
                  </div>
                          ...
                          <a-card
                            ...
                            <template #actions>
                              ...
                              <a v-else-if="currentPasswordManager.name === item.name" style="color:#1890ff"
                                @click="setPasswordManager(item)"><check-circle-outlined /> 当前使用中</a>
                              <a v-else="currentPasswordManager.name===item.name"
                                @click="setPasswordManager(item)"><check-circle-outlined /> 设置</a>
              ...
              <h3>内置密码库内的密码（任何使用此浏览器的用户均可切换到内置密码库，重要密码建议使用独立密码库） <a-button @click="importPwd" style="float: right"
                  size="small" type="primary"><import-outlined /> 导入密码</a-button> </h3>
              <Passwords />
            </div>
            ...
            <div class="settings-container" id="proxy-settings-container">
              ...
              <div class="setting-section" id="manual-proxy-section">
                ...
                <div class="setting-option">
                  ...
                  <input name="proxyBypassRules" id="proxy-bypass-rules-input"
          ...
          <a-tab-pane :forceRender="true" key="Bangs">
            ...
            <div class="settings-container" id="custom-bangs-container">
              ...
              <div class="setting-section">
                ...
                <button data-string="settingsCustomBangsAdd" id="add-custom-bang"></button>
              </div>
            </div>
          </a-tab-pane>
