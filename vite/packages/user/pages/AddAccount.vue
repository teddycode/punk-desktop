<template>
  <div>
    <h1 style="font-size: 18px; margin: auto; margin-top: 20px; margin-bottom: 10px; text-align: center">添加新帐号</h1>
    <div style="text-align: center">
      <a-avatar :size="60"> 头像 </a-avatar>
    </div>
    ...
    <p style="text-align: center; color: #333">目前暂不支持云收藏夹、云密码。</p>
