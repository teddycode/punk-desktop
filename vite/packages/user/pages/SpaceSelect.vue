  ...
  <a-layout style="overflow: hidden">
    <a-layout-sider :width="230" style="background: #f1f1f1; height: 100vh; border-right: 1px solid #dadada">
      ...
      <vue-custom-scrollbar :settings="settings" style="position: relative; height: calc(100vh - 45px)">
        <SpaceList
          ...
          v-model:activeSpace="activeSpace"
          :spaces="spaces"
          :user="user"
          @setActive="setActive"
        ></SpaceList>
    ...
    <a-layout>
      <a-layout-content style="overflow: hidden">
        ...
        <vue-custom-scrollbar
          :settings="settings"
          style="position: relative; height: calc(100vh - 50px); padding: 10px"
        >
          <TaskList
        ...
        <div>
          ...
          >
            ...
            <p>
              <a-input-password
                ref="enterPwdInput"
                @keyup.enter="doSetEnterPwd"
                v-model:value="newEnterPwd"
                placeholder="留空不使用"
              ></a-input-password>
            </p>
            <p></p>
      ...
      <a-layout-sider
        style="background: white; padding: 10px; box-shadow: 0 0 8px rgba(0, 0, 0, 0.38)"
        v-if="showHistory"
      >
        <h3>
          <history-outlined />
