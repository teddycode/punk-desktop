<template>
  <div style="text-align: center;padding-top: 70px">
    ...
    <div style="position: absolute;right: 10px;top: 10px">
      <a-tag class="text-more" style="max-width: 150px" title="当前设备ID" @click="reName">
        <desktop-outlined/>
        {{ this.getClientName() }}
      </a-tag>
    ...
    <p>
      <a-button type="primary" @click="startApp()">打开上次空间</a-button>
    </p>
    <!--    <p>-->
  ...
  <div style="position: absolute;bottom: 20px;text-align: center;width: calc( 100% - 200px) ">
    <div>
      ...
      <a-checkbox v-model:checked="showOnStart" @change="switchShowOnStart">每次启动的时候选择</a-checkbox>
    </div>
    <div v-if="hideTrialTip==='false'" class="tip" style="">
      <a-row style="cursor: pointer" type="flex" @click="showTrial">
        <a-col flex="60px">
          <a-avatar :size="50" shape="square" src="/icons/bilibili.svg"/>
        </a-col>
        <a-col flex="1">
          <h3>快速学习空间功能</h3>
          <div>
            通过视频教程，系统学习掌握空间的使用技巧。强烈推荐。
            <span class="clickable"> <close-outlined style="position: absolute;right: 5px;top: 5px;cursor: pointer"
                                                     @click.stop="hideTrial()"/></span>
