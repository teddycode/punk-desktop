...
export const appStore = defineStore('app', {
  ...
  actions: {
    ...
    async saveDevApp() {
      ...
      if (
        (!this.devApp.window.frameWindow.enable &&
          !this.devApp.window.window.enable &&
          !this.devApp.window.attach.enable) ||
        !this.devApp.window[this.devApp.window.defaultType].enable
      ) {
