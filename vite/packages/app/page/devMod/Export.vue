<template>
  <h3>
    导出工具
    <a-button size="small" @click="openDir" style="float: right" v-if="this.devApp.local_dir">打开项目目录</a-button>
  </h3>
  <a-tabs>
    <a-tab-pane key="appjson" tab="导出manifest.json">
      <p>
        以下为自动根据设置导出的manifest.json文件，您可以直接复制，或者保存为文件。此文件可用于应用市场上架。为了方便起见，您甚至可以直接一键上架到应用市场。
      </p>
