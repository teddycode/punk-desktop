    ...
    <div style="display: flex">
      <div>
        <div class="logo" style="font-size: 16px; margin-right: 20px; font-weight: 700">
          <a-avatar style="margin-right: 10px" src="/icons/dev.svg"></a-avatar> 开发模式
        </div>
      </div>
      <div style="flex: auto">
        <a-menu
        ...
        >
          <a-sub-menu>
            <template #title> 开发中的项目 </template>
            ...
            <a-menu-item key="all">
              <router-link :to="{ path: '/allDevapps' }"><strong>全部项目</strong> </router-link>
            </a-menu-item>
          </a-sub-menu>
      ...
      <div>
        <span @click="login" v-if="!user" style="cursor: pointer"> <a-avatar> 开 </a-avatar> 登录</span>
        <a-dropdown v-else>
          <a-avatar :src="user.user_info.avatar"> </a-avatar>
  ...
  <a-layout>
          ...
          >
            ...
            <a-sub-menu v-if="debugMod" key="basicDev">
              ...
              <a-menu-item v-if="debugMod" key="window">
                <router-link :to="{ path: '/dev/window' }"><strong>窗体设置</strong> </router-link>
              </a-menu-item>
            </a-sub-menu>
        ...
        <div style="height: 160px; padding: 10px">
          <div style="width: 82%; margin: auto; margin-bottom: 10px">
            <router-link :to="{ path: '/dev/wizard' }"
              ><a-button block type="danger"> <smile-outlined /><strong>&nbsp; 开发向导</strong></a-button>
            </router-link>
          </div>
    ...
    <a-layout-content>
      ...
      >
        <template #extra>
          <a-button-group>
            <a-button type="primary" @click="run"> 运行测试应用 </a-button>
