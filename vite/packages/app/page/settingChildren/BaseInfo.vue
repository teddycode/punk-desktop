<template>
  ...
  <a-form :model="userSetting" style="padding: 20px" :label-col="{ span: 5 }" :wrapper-col="{ span: 19 }">
    ...
    <a-form-item label="应用名" :rules="{ required: true, message: '应用名称，长度大于1，小于16', min: 1, max: 16 }">
      <a-input v-model:value="userSetting.name" placeholder="输入应用名称" />
    </a-form-item>
    ...
    <a-form-item label="应用说明" :rules="{ required: true, message: '请输入应用说明' }">
      <a-textarea v-model:value="userSetting.summary" placeholder="输入应用说明" :maxlength="50" />
    </a-form-item>
