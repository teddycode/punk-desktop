  ...
  <a-layout style="height: calc(100vh)">
    <a-layout>
          ...
          <div style="height: 50px">
            <div style="text-align: center; width: 100%">
              ...
              <a-dropdown>
                ...
                <a-button @click="reset"> 重置 <DownOutlined /> </a-button>
              </a-dropdown>
            </div>
          </div>
        </div>
      ...
      <a-layout-content>
        ...
        >
          <template #extra>
            <a-button key="1" type="danger" @click="uninstall(appId)" v-if="!app.isSystemApp"> 卸载应用 </a-button>
            <span v-else>
              <a-tooltip title="系统应用，不可卸载">
                <a-button disabled size="small" key="1" @click="uninstall(appId)"> 卸载应用 </a-button>
              </a-tooltip>
            </span>
          </template>
        </a-page-header>
