<template>
  <div class="flex justify-between">
    ...
    <div @click="getColor()" class="flex items-center xt-theme-text cursor-pointer">
  ...
  <div>
    <div class="flex my-2 h-12" style="">
      ...
      <XtInput class="xt-bg-2 flex-1 relative" v-model="RGB">
        <template #addonBefore>
          <div class="h-full flex items-center xt-text justify-between px-4 relative left-box"></div>
          <div class="absolute xt-text top-1/2 -translate-y-1/2 text-base" style="left: 10px">RGB</div>
        </template>
      </XtInput>
      ...
      <XtInput class="xt-bg-2 flex-1" v-model="HEX">
        <template #addonBefore>
          <div class="h-full flex items-center xt-text justify-between px-4 relative left-box"></div>
          <div class="absolute xt-text top-1/2 -translate-y-1/2 text-base" style="left: 10px">HEX</div>
        </template>
      </XtInput>
    ...
    <div class="flex my-2 h-12">
      ...
      <XtInput class="xt-bg-2 flex-1" v-model="HSV">
        <template #addonBefore>
          <div class="h-full flex items-center xt-text justify-between px-4 relative left-box"></div>
          <div class="absolute xt-text top-1/2 -translate-y-1/2 text-base" style="left: 10px">HSV</div>
        </template>
      </XtInput>
      ...
      <XtInput class="xt-bg-2 flex-1" v-model="HSL">
        <template #addonBefore>
          <div class="h-full flex items-center xt-text justify-between px-4 relative left-box"></div>
          <div class="absolute xt-text top-1/2 -translate-y-1/2 text-base" style="left: 10px">HSL</div>
        </template>
      </XtInput>
