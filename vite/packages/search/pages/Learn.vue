<template>
  <div style="padding: 20px">
    <a-input-search
      ...
      @search="onSearch"
    />
    <a-select ref="select" v-model:value="sampleType" style="width: 120px" @change="handleChange" @focus="focus">
  ...
  <a-modal v-model:visible="visible" width="100%" wrap-class-name="full-modal" :footer="null">
    <div>
      <a-row>
        <a-col :span="2">
...
const data = [
  {
    ...
    summary: '基于已经存在的知识提问',
    prompt: `我是一个高度智能的问答机器人。如果你问我一个植根于真理的问题，我会给你答案。如果你问我一个无稽之谈、诡计多端或没有明确答案的问题，我会回答“未知”。
...
木星是距离太阳的第五颗行星，也是太阳系中最大的行星。它是一颗气态巨行星，质量是太阳的千分之一，但是太阳系中所有其他行星总和的两倍半。木星是夜空中肉眼可见的最亮的天体之一，早在有记载的历史之前就为古代文明所知。它以罗马神木星命名。[19]从地球上看，木星的亮度足以使其反射光投射出可见的阴影，[20]并且平均是夜空中仅次于月球和金星的第三亮自然物体。`,
    response:
      '木星是距离太阳的第五颗行星，非常大而明亮。它可以在夜空中用我们的眼睛看到，自古以来就为人所知。它的名字来自罗马神木星。它通常是夜空中第三亮的物体，仅次于月球和金星。',
  },
  {
