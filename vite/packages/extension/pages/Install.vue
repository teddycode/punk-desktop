  ...
  <div class="card-container" style="padding:20px;overflow: hidden">
    <a-row>
      <a-col style="width: 50px">
        <a-avatar :src="iconPath" shape="square"></a-avatar>
      </a-col>
      <a-col style="width: 350px">
        <p>
          <strong> 安装扩展 {{ name }} 到 磐古跨链客户端？ </strong>
        </p>
        <p>
          该扩展需要：
          <ul class="permissions" style="max-height: 170px;overflow-y: auto">
    ...
    <div style="text-align: right;position: fixed;bottom: 15px;right: 15px">
      ...
      <a-button type="primary" @click="setup">安装</a-button>
    </div>
  </div>
</template>
