        ...
        <a-row :gutter="10">
          ...
          >
            <span style="cursor: pointer" type="text">
              ...
              &nbsp;
              <span v-if="message.body"> {{ message.body }} </span><span v-else>{{ message.title }}</span
              ><br /><span style="font-size: 12px; color: grey; margin-left: 34px">
                {{ this.friendlyDate(message.create_time) }}</span
              >
              &nbsp;&nbsp;</span
            >
          </a-col>
