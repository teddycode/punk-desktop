<template>
  <div class="main">
    <div class="box-title flex justify-start align-center">
      <dashboard-outlined class="box-icon"/>
    ...
    <div class="box-content content-small flex flex-direction">
      ...
      <div>
        <a-progress :percent="percentage" :showInfo="false" strokeColor="#f59923" trailColor="#4d4d4d"/>
      </div>
      <div class="flex">
      ...
      <div style="text-align: right">
        <span class="text-button" size="small" style="font-size: 12px;" @click="release()"><rocket-outlined/> 释放</span>
      </div>
    </div>
  </div>
</template>
