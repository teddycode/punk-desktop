<template>
  <div class="main">
    <div class="box-title flex justify-start align-center">
      ...
      <div class="box-extra">
        <swap-outlined class="text-button" title="切换空间" @click="switchSpace"/>
      </div>
    </div>
    <div class="box-content">
      <div v-if="currentSpace.name">
        <div class="text-more" style="margin-bottom: 5px">
          <img src="/icons/box.svg" style="width: 20px"/> {{ currentSpace.name }}
        </div>
      ...
      <span v-else>
         <a-empty :description="null" :image="simpleImage" style="    margin: 0;
    color: rgba(0, 0, 0, 0.25);
    margin-bottom: 0;
    padding-top: 17px;"></a-empty>
       </span>
    </div>
  </div>
</template>
...
<script lang="ts">
import {CloudSyncOutlined, CommentOutlined, SwapOutlined} from '@ant-design/icons-vue'
