      ...
      <a-col :span="24">
        <a-row>
          <a-col :span="10" style="text-align: right">
            <a-avatar style="position: relative; cursor: pointer" :size="60" :src="user.avatar"> </a-avatar>
          </a-col>
        ...
        <a-row>
          <div class="arrow-box" style="width: 100%; line-height: 3">
            <div class="" style="line-height: 2; margin-bottom: 5px">
              在线等级: <span style="font-size: 20px">{{ grade.lv }}</span
              >级
              <div
                v-if="badge.rank < 300"
                style="
            ...
            <div class="text-grey" style="line-height: 2">
