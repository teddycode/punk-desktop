<template>
  <Widget ref="clockSlot" :customIndex="customIndex" :desk="desk"
    ...
    <div class="icon-box" style="color: rgba(255,255,255,0.85);">
      <!-- 开始 -->
      <div v-if="running && isPause" class="icon" @click="onPause">
      ...
      <!-- 结束 -->
      <div v-if="running" class="icon" @click="onStop">
      ...
      <vue-custom-scrollbar :settings="settingsScroller" style="height: 100%;">
        <div class="setting-box">
          <div class="setting">
            ...
            <div class="right-box">
              <a-switch v-model:checked="isFull" @change="onChange(this.customIndex,this.desk)"/>
            </div>
          </div>
          <div class="setting">
            <div class="left-box">
            ...
            <div class="right-box">
              <a-switch v-model:checked="isState" @change="onChange(this.customIndex,this.desk)"/>
            </div>
          </div>
        </div>
