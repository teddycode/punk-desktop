<template>
  <xt-button v-if="this.isState&&this.running" :h="30" :style="{'background' : this.isColor}" :w="80"
             class="tomato-timer pointer no-drag   mr-2 "
             @click="onChangeFull">
    ...
    <div v-show="isFullState" style="position: absolute;left:0;top:31px">
