<template>
  ...
  <a-drawer v-model:open="setShow" title="设置" width="500" placement="right">
    ...
    <div
      class="flex items-center pointer justify-center bt-bg button-active button-bg primary-title rounded-lg p-3"
  ...
  <!-- 主题色模块 -->
  <HorizontalDrawer
    :rightSelect="themeType"
    ref="themeRef"
    v-model:selectRegion="settings.clipTheme"
    @getArea="getTheme"
  >
  </HorizontalDrawer>
  ...
  <HorizontalDrawer
    ...
    v-model:selectRegion="settings.clipMode"
    ref="languageRef"
    @getArea="getLanguage"
  ></HorizontalDrawer>
</template>
