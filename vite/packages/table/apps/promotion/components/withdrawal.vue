      ...
      <div
        ...
        <Modal blurFlag="true" style="z-index:99999;">
          <div class="p-5 xt-modal flex flex-col justify-center items-center"
               style="width:500px;height:280px;border-radius:12px;border: 1px solid rgba(255,255,255,0.1);box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.5);background: #212121;">
            ...
            <div class='flex font-16' style='color: rgba(255,255,255,0.60);width:100%;justify-content: flex-end;'>
              <div class='no-drag btn-active input pointer flex justify-center items-center'
                   style='width:64px;height:40px;background: #2A2A2A;' @click='promptVisible=false'>取消
              </div>
