        ...
        <Modal blurFlag="true" style="z-index: 99999">
          ...
          >
            ...
            <a-textarea
              ...
              placeholder="请输入原因"
            />
            <div class="flex font-16" style="color: rgba(255, 255, 255, 0.6); width: 100%; justify-content: flex-end">
              <div
                class="no-drag btn-active input pointer flex justify-center items-center"
                @click="promptVisible = false"
                style="width: 64px; height: 40px; background: #2a2a2a"
              >
                取消
              </div>
