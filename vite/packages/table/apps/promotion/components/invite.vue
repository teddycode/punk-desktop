  ...
  <vueCustomScrollbar :settings="scrollbarSettings">
    <div class="page-container rounded-xl box-body" style="height: 100%">
      <div class="flex-box">
        ...
        <a-table :dataSource="keyWord.data" :pagination="{ pageSize: 3 }" :columns="keyWordCol" class="table-box" />
      </div>
      <div class="flex-box">
        <div class="box-title">{{ detailList.title }}</div>
        <a-table :pagination="{ pageSize: 5 }" :dataSource="detailList.data" :columns="detailCol" class="table-box" />
      </div>
    </div>
    <a-modal
      :visible="visible"
    ...
    >
      <div class="modal-box" v-if="modalState != 3">
        <div class="modal-header">
          ...
          <span class="header-title"> 推广说明 </span>
        ...
        <div class="modal-content" v-if="modalState == 1">
          ...
          voluptas. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex soluta ab enim id numquam laborum error
          magni adipisci repudiandae culpa, tempore reiciendis itaque, accusamus
        </div>
