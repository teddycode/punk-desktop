<template>
  <vueCustomScrollbar :settings="scrollbarSettings">
    ...
    <a-modal :closable="false" :footer="null" :visible="visible"
             centered
             class="modal-box"
             height="500px"
             ...
             width="600px"
             @ok="handleOk">
      <div v-if="modalState != 3" class="modal-box">
        <div class="modal-header">
          <div v-if="modalState == 2" class="left-icon rounded-lg xt-btn no-drag" @click="modalState = 1">
            <LeftOutlined/>
          </div>
        ...
        <div v-if="modalState == 1" class="modal-content">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex soluta ab enim id numquam laborum error magni
          adipisci repudiandae culpa, tempore reiciendis itaque, accusamus reprehenderit sit optio inventore quae
          voluptas.
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ex soluta ab enim id numquam laborum error magni
          adipisci repudiandae culpa, tempore reiciendis itaque, accusamus
        </div>
        <div v-if="modalState == 2" class="modal-content content-box">
          <a-textarea
              v-model="passKey"
              auto-size
          ...
          />
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. At alias quos molestiae, laboriosam et quod
            obcaecati quae quibusdam. Laudantium, debitis? Quibusdam beatae consequatur voluptate! Eos corporis
            recusandae similique officia enim!
          </p>
          <a-textarea
              v-model="passContent"
        ...
        <div class="modal-footer">
          ...
          <button v-if="modalState == 1" class="btn-active xt-active-btn " @click="modalState++">同意</button>
          <button v-if="modalState == 2" class="btn-active xt-active-btn" @click="onAgree">提交</button>
        </div>
      </div>

      <div v-if="modalState == 3" class="modal-success">
        <div>提交成功</div>
        <div>
