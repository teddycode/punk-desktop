<template>
  <div class="mr-3 h-full overflow-hidden" style="min-width: 400px">
    ...
    <Modal v-if="promptVisible" blurFlag="true" style="z-index: 99999">
      <div
        class="p-5 pt-1 pb-1 flex flex-col justify-center"
        style="
          width: 500px;
          height: 516px;
          border-radius: 12px;
      ...
      >
        <div style="width: 100%; height: 46px; position: relative; color: var(--primary-text)">
          ...
          <div
            class="flex justify-center items-center pointer btn-active"
            style="
              position: absolute;
              top: -5px;
              right: -7px;
        ...
        <div class="mt-1">
          ...
          <div class="overflow-hidden xt-scrollbar mt-3" style="height: 336px">
            <div
              class="w-full flex items-center rounded-lg pointer"
              style="height: 64px; background: var(--secondary-bg); justify-content: space-between; padding: 0 24px"
              v-for="(item, index) in this.desks"
              :key="index"
              :style="{
                background: this.selIndex == index ? 'rgba(80,139,254,0.20)' : 'var(--secondary-bg)',
                border: this.selIndex == index ? '1px solid rgba(80,139,254,1)' : '1px solid transparent',
        ...
        <div class="flex font-16 mt-2" style="color: rgba(255, 255, 255, 0.6); width: 100%; justify-content: flex-end">
