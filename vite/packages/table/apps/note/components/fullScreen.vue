<template>
  <teleport to="body">
    ...
    <div class="pop-box flex flex-wrap justify-center">
      <!-- 顶部 -->
      <div
        style="justify-content: space-between; background-color: var(--secondary-bg); height: 64px"
        class="flex w-full items-center pl-3 pr-3"
      >
        ...
        <div class="flex" style="position: relative">
          ...
          >
            <div
              class="flex rounded-lg pointer"
              style="height: 40px; width: 40px"
              v-for="(item, index) in this.noteBgColor"
              :key="index"
          ...
          <div
            class="flex items-center pointer justify-center mr-3"
          ...
          <xt-menu :menus="menus" model="click">
            <div
              class="flex items-center pointer justify-center no-drag"
              style="width: 40px; height: 40px; background: var(--mask-bg); border-radius: 10px"
            >
      ...
      <div class="h-full" style="width: 950px; margin-top: 75px">
        <div
          class="shadow overflow-hidden h-full"
          style="border-radius: 12px; padding: 24px 0 0 0"
          :style="{ background: background }"
        >
          <a-input
            style="
