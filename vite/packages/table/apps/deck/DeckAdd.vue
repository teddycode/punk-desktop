  ...
  <div class="s-bg m-2 rounded-md px-5 xt-bg xt-text" style="height: calc(100% - 20px)">
    ...
    <div style="font-size: 18px; display: flex; flex-direction: column; height: 100%">
      <h3 class="mt-3" style="text-align: center">
        <span v-if="!this.id"> 添加自定义按钮 </span>
        <span v-else> 编辑 - {{ this.data.title }} </span>
      </h3>
        ...
        <div v-if="tab === 'input'" style="width: 100%; display: flex; flex-direction: row">
          <div>
            <div class="line preview" style="text-align: center">
              <div class="line-title" style="padding: 1em; text-align: center">效果预览</div>
              <div class="item-wrapper">
                ...
                <div v-else>
                  <CustomIcon v-if="icon" style="font-size: 60px; margin-top: 0.15em" :icon="icon"></CustomIcon>
                </div>
              </div>
              <div style="text-align: center; margin-top: 1em; margin-right: 0">
                ...
                <a-button v-else type="primary" @click="doAdd"> 保存按钮 </a-button>
              </div>
            </div>
          </div>
          <div class="ml-4" style="flex: 1">
            <div class="line-title">名称</div>
            <div class="line">
              <a-input
                @change="syncTitle"
                style="width: 20em"
            ...
            <div class="line">
              <a-radio-group v-model:value="type">
                <a-radio value="font"> 文字按钮 </a-radio>
                <a-radio value="icon"> 图标按钮 </a-radio>
              </a-radio-group>
            </div>
            ...
            <div v-else class="line">
              <span style="margin-right: 1em"
                ><CustomIcon v-if="icon" style="font-size: 60px" :icon="icon"></CustomIcon>

                <a-avatar v-else :size="60"></a-avatar
              ></span>
            ...
            <div class="line">
              <div
                ...
                :style="{ 'border-left-color': data.group.color }"
