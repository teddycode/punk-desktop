  ...
  <div class="add-content">
    ...
    <div class="flex">
      ...
      <div class="ml-10 xt-text-2" style="font-size: 16px">
        ...
        <div
          class="pointer xt-bg-2 xt-text-2 flex items-center rounded-lg justify-center mr-3 mt-2"
          @click="refresh"
    ...
    <a-row :gutter="10" class="mt-3">
      <a-col :span="16">
        <xt-button @click="save" type="theme" style="width: 100%">保存 </xt-button>
      </a-col>
      <a-col :span="8">
        <xt-button @click="removeApp" type="error"> 删除软件 </xt-button>
      </a-col>
    </a-row>
  </div>
</template>
