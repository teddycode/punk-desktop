...
<template>
  ...
  <div class="add-content">
    ...
    <div class="flex">
      <div class="avatar">
        <div>
          <a-avatar :size="100" :src="formApp.icon" shape="square"/>
        </div>
      </div>
      <div class="ml-10 xt-text-2" style="font-size: 16px;">
        ...
        <div class="pointer xt-bg-2 xt-text-2 flex items-center rounded-lg justify-center mr-3 mt-2"
             style="width:120px; height:48px;" @click="refresh">重新获取
        </div>
      </div>
    </div>
    <span>软件名称</span>
    ...
    <a-row :gutter="10" class="mt-3">
      <a-col :span="16">
        <xt-button style="width: 100%" type="theme" @click="save"
        >保存
        </xt-button>
      </a-col>
      <a-col :span="8">
        <xt-button type="error" @click="removeApp">
          删除软件
        </xt-button>
      </a-col>
    </a-row>
