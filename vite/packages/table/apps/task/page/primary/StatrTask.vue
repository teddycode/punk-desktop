<template>
  ...
  <!-- 任务按钮 -->
  <xt-button v-if="isFirst && store.success" style="background: #faad14 !important; width: 100%" @click="receive()"
    >领取奖励</xt-button
  >
  <xt-button v-else style="width: 100%" type="theme" @click="taskGuide()">开始任务</xt-button>
</template>
