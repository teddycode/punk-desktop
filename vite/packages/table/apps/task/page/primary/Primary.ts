export const tasks = [
  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        repeatable: '是',
        frequency: '一次',
        intro: '工作台背景太单调？我们提供了自定义壁纸功能，支持选择内置的开源壁纸，或者你可以手动上传自己喜欢的壁纸。',
      ...
      },
      {
        ...
        repeatable: '是',
        frequency: '一次',
        intro: '工作台提供了强大的底部和侧边导航栏，你可以按照需要自定义修改需要放置的应用或图标。',
        description:
    ...
    tasks: [
      {
        ...
        frequency: '一次',
        guide: true,
        intro: '想要在工作台中快速访问系统桌面图标，仅需几步简单操作即可一键导入桌面图标，在工作台中自由管理和拖放。',
        description:
  ...
  {
    chapter: '第三章',
    info: '了解如何进一步个性化你的工作台，自定义桌面、主题和小组件。',
    tasks: [
      {
        id: 'M0301',
        title: '自定义工作台主题颜色',
      ...
      },
      {
        ...
        repeatable: '是',
        frequency: '一次',
        intro: '你可以根据使用场景创建新的桌面，并从默认模板开始调整布局。',
        description: '在桌面空白处「单击右键」，在底部出现的操作栏中选择「添加桌面」，填写名称后选择初始布局。',
      },
      {
        id: 'M0303',
        title: '配置一个外部小组件',
        ...
        repeatable: '是',
        frequency: '一次',
        intro: '没有自己想要的小组件？我们提供的自定义小组件支持添加url地址，来实现将外部网页变为桌面小组件。',
        description: '打开「外部小组件」的底部操作菜单，选择「设置」，填写网页地址并保存即可。',
      },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        frequency: '一次',
        guide: true,
        intro: '看来你已经熟悉了工作台的主要核心功能，来试下使用快捷键，进一步提升打开体验。',
        description: '在「设置」页面，点击「通用设置」，可以看到「按键」菜单，在这里你可以自定义设置适合的快捷键。',
      },
    ],
  },
];
