<template>
  <Modal v-if="visible" :visible="visible">
    <div
      ...
      style="padding: 12px; width: 650px; height: 534px; background: var(--modal-bg)"
    >
      <div class="w-full h-12 flex items-center justify-center mb-4" style="position: relative">
        ...
        <div
          class="close-button active-button pointer flex rounded-lg items-center justify-center"
        ...
        <div class="flex flex-col" style="width: 293px">
          ...
          <vue-custom-scrollbar :settings="settingsScroller" style="height: 350px">
            ...
            <div
              ...
              class="flex items-center rounded-lg p-3 pointer"
          ...
          <div class="flex justify-end h-12">
            <div class="flex items-center">
              ...
              <a-button
                ...
                type="primary"
                style="width: 100px; height: 44px; color: var(--active-text)"
                @click="doShare"
                >分享
              </a-button>
            </div>
