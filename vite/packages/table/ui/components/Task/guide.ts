export const guide = {
  ...
  M0101: [
    ...
    {
      title: '桌面操作菜单',
      text: '点击这里（或桌面空白处「单击右键」），打开桌面的底部操作栏，可以选择桌面相关的功能操作。',
    },
    {
      time: 300,
      title: '添加小组件',
  ...
  M0302: [
    ...
    },
    {
      time: 500,
      title: '添加桌面',
      text: '点击这里打开「添加桌面」侧滑弹窗。',
    },
    {
      time: 300,

      title: '添加桌面',
      text: '在这里输入桌面名称，并从默认模版中选择一个初始布局。',
      next: '好的',
    },
    {
      title: '添加桌面',
      text: '选择一个适合当前场景的初始布局。',
      position: 'left',
    },
    {
      title: '添加桌面',
  ...
  M0303: [
    ...
    },
    {
      time: 300,
      title: '外部小组件',
      text: '「外部小组件」是一个可以自由修改内容的特殊小组件，你可以选择喜欢的网页地址作为小组件的数据。右键单击或点击右上角更多按钮，在底部操作菜单中选择「设置」。',
    },
    {
      time: 300,
      title: '设置',
      text: '输入网页地址并保存，小组件就会显示对应网页内容。',
      next: '好的',
    },
    {
      success: true,
