  ...
  >
    ...
    <div class="h-full flex-grow flex flex-col">
      ...
      <div class="flex items-center relative">
        ...
        <XtIcon class="no-darg" v-if="currentType == 'popup'" icon="guanbi1" :class="setSpacing('ml')" @click="close()">
        </XtIcon>
        <XtIcon
          v-if="showFull"
  ...
  computed: {
    typeStyle() {
      let typeList = {
        ...
        popup: 'fixed top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 rounded-xl xt-modal  xt-shadow ',
