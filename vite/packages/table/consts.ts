...
const Server = {
  ...
  baseUrl: 'http://123.157.213.104:18081/api',
};
    ...
    actions: [
      {
        ...
        name: 'sendKeys',
        summary:
          '调用全局快捷键，可实现音频控制等功能。直接输入单词即可，例如ctrl+x，<a href="https://www.yuque.com/tswork/mqon1y/mm28svv194g628gc" target="_blank">查看帮助</a>',
        inputs: [
          {
  ...
  },
  {
    ...
    actions: [
      ...
      // },
      {
        ...
        title: '钉钉机器人',
        summary:
          '发送消息到钉钉机器人，具体需要如何配置，支持变量（需配合条件），可参考<a target="_blank" href="https://open.dingtalk.com/document/robots/custom-robot-access#title-7ur-3ok-s1a">钉钉官方文档</a>',
        defaultValue: {
          msgtype: 'text',
        },
        inputs: [
  ...
  },
  {
    ...
    actions: [
      ...
      },
      {
        ...
        title: '执行nircmd的命令行',
        summary:
          '直接执行工作台内置的nircmd，可查考此处的nircmd的命令，此操作不需要再安装nircmd，工作台自带了。点此查看<a target="_blank" href="https://www.yuque.com/tswork/mqon1y/ptyx9br06bceaaiv">nircmd的手册</a>。',
        inputs: [
          {
            name: 'cm',
            title: '参数，回车换行，每行参数会顺序执行',
      ...
      },
      {
        ...
        summary:
          '执行SoundVolumeView命令行工具，这个工具的音频设备操作能力比nircmd更强，可<a target="_blank" href="https://www.nirsoft.net/utils/sound_volume_view.html">参考此处</a>的命令。',
        inputs: [
          {
            name: 'cm',
            title: '参数，回车换行，每行参数会顺序执行',
      ...
      },
      {
        ...
        summary:
          '执行MultiMonitorTool命令行工具，这个工具主要用于操作显示器，可<a target="_blank" href="https://www.nirsoft.net/utils/multi_monitor_tool.html">参考此处</a>的命令。',
        inputs: [
          {
            name: 'cm',
            title: '参数，回车换行，每行参数会顺序执行',
