<template>
    ...
    <div class="w-full h-full flex justify-center flex-row flex-wrap">
      <div class="w-full flex flex-col top-card mr-4" style="max-width: 572px">
        ...
        <div class="rounded-lg flex-1 w-full tip-card px-5 text-white" style="background: var(--primary-bg)">
          ...
          <div
            class="h-2/3 w-full rounded-lg flex flex-col justify-evenly px-4 mt-2 xt-bg-2"
            ...
            <div
              ...
              :style="
                item.detail[[leveList[clickGrade]]]
                  ...
                  : 'background: var(--secondary-bg);opacity: 0.6;'
              "
            >
              <Icon
                :icon="item.icon"
                style="width: 24px; height: 24px; color: var(--primary-text)"
                class="mr-4 ml-2 text-white"
              ></Icon>
  ...
  <div class="home-blur fixed inset-0 float-tip" style="z-index: 999" v-if="tipFlag" @click.stop="closeTip">
    <div
      class="rounded-lg w-96 h-60 px-5 text-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
    ...
    >
      ...
      <div
        class="h-2/3 w-full rounded-lg flex flex-col justify-evenly px-4 mt-2"
