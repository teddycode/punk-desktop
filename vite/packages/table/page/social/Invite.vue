<template>
  <div
    class="s-bg ml-3 p-3 rounded-xl xt-bg"
    style="width: 850px; min-height: 300px; display: flex; flex-direction: column; max-height: 100%"
  >
    <div class="mb-3" style="width: 300px">
      <HorizontalPanel :nav-list="tabs" v-model:select-type="tab"> </HorizontalPanel>
    </div>
            ...
            <template #bodyCell="{ column, record, index }">
              ...
              <template v-else-if="column.key === 'key'">
                <span
                  ...
                  class="mr-3"
                  :style="{
                    background: isMarked(record.key) ? '#35ad03' : 'transparent',
                    textDecoration: record.status === 2 ? 'line-through' : 'none',
                  }"
                >
                  {{ record.key }}
                </span>
        ...
        <template v-if="verified">
          <div class="text-center xt-text" style="min-height: 300px">
            ...
            <div
              ...
              class="p-3 rounded-2xl m-3 inline-block"
            >
              <div>
        ...
        <template v-else>
          ...
          <div class="mt-2">
            <a-input
              ...
              placeholder="请输入邀请码"
              style="background: var(--secondary-bg); width: 250px"
              v-model:value="code"
            ></a-input>
          </div>
          <div class="mt-2">
