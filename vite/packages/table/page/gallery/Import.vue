<template>
  ...
  <!--    </a-input-group>-->
  <!--  </div>-->
  <div class="line-title">数据库修复</div>
  <div class="line">
    <a-button @click="clearFix"> 清空并修复数据库 </a-button>
  </div>
  ...
  <div class="line">
    <div
      style="border-radius: 1em; background: #282828; border: 1px dashed #505050; text-align: center; padding: 2em"
