  ...
  <div class="pl-2">
    <template v-for="item in chatList" :key="item.id">
      <div class="flex justify-end mb-3" v-if="item.role === 'user'">
        <div class="flex flex-col">
          <div class="flex">
            ...
            <img :src="img" alt="" style="width: 32px; height: 32px; border-radius: 50%" />
          </div>
          <div class="flex justify-end items-center cursor-pointer my-2">
            <xt-button type="2222" h="16" w="60" size="mini" :copy="item.content" class="xt-text-2">
      ...
      <div v-else class="flex flex-col">
        ...
        <xt-button type="" h="16" w="60" size="mini" :copy="item.content" class="xt-text-2 my-2">
          <xt-base-icon icon="fuzhi" />
          复制
        </xt-button>
      </div>
