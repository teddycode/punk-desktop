    ...
    >
      <div style="width: auto">
        <div style="display: inline-block; vertical-align: top">
          <div class="xt-bg xt-text" style="margin: 2em; padding: 2em; border-radius: 0.5em; width: 40em">
            <h3 class="xt-text">
              音量
          ...
          >
            ...
            <div v-for="audio in audioList">
              <div
                ...
                class="audio xt-bg-2"
                :class="{ active: audio.isDefaultForMultimedia }"
              >
