  ...
  <div @resize="updateScroller" class="container flex flex-col xt-text">
    <div class="top-bar">
      <div class="left shrink h-[40px] flex">
        ...
        <button class="mr-3 border-0 rounded-md xt-bg pointer w-[40px] h-[40px]" style="flex-shrink: 0" @click="goBack">
          <Icon class="text-lg xt-text" style="vertical-align: sub" icon="fluent:chevron-left-16-filled" />
        </button>
        <div
          class="h-[40px] xt-bg rounded-lg text-center font-16 mr-3 xt-text-2 pl-1 pr-1 flex items-center"
          style="line-height: 40px"
        >
          <div class="xt-text">想天工作台</div>
      ...
      <div class="flex mr-6 right">
        ...
        <button
          class="ml-3 border-0 rounded-md xt-bg pointer w-[40px] h-[40px]"
          @click="refreshPost"
          style="flex-shrink: 0"
        >
