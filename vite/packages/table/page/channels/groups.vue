<template>
  <div class="h-full">
    <div class="flex justify-between">
      <div class="flex">
        <HorizontalPanel v-model:selectType="groupsType" :navList="groupsList" style="height: 40px;">
        </HorizontalPanel>
        <div>
          ...
          <a-select :bordered="false" autoClearSearchValue="false"
                    class="ml-3"
                    style="width: 120px;height: 40px;border-radius: 8px;line-height: 46px;margin-left: 12px;font-size: 16px;">
            <a-select-option v-for="(item, index) in options" :value="index"
