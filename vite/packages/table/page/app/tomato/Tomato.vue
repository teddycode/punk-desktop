    ...
    <a-row style="margin-left: 5em">
      ...
      <a-col style="font-size: 3em; text-align: center; padding-top: 1em" :soan="16">
        ...
        <div style="">
          <Icon
            v-for="i in tomato"
            style="margin-right: 10px; vertical-align: middle; font-size: 1.5em"
            icon="fanqie"
          ></Icon>
          <Icon
            v-for="i in target - tomato"
            style="margin-right: 10px; vertical-align: middle; opacity: 0.3; font-size: 1em"
            icon="fanqie"
          ></Icon>
        </div>
          ...
          <a-row :gutter="30" v-if="running">
            <a-col @click="pause" :span="12">
              <div class="btn sm" v-if="timer">
                ...
                <span style="font-size: 0.7em"> 暂停 </span>
              </div>
            ...
            <a-col @click="stop" :span="12">
              <div class="btn sm">
                ...
                <span style="font-size: 0.7em">放弃 </span>
              </div>
            </a-col>
          </a-row>
        ...
        (
          (1 -
            (this.seconds + this.minutes * 60 + this.hours * 60 * 60) /
              (this.totalTime.seconds + this.totalTime.minutes * 60 + this.totalTime.hours * 60 * 60)) *
          100
        ).toFixed(),
      );
    },
