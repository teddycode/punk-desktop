<template>
  <div class="flex flex-row items-center justify-center w-full h-full">
    <div v-if="!setUp"
      ...
      <div class="mt-4 text-xs" style="line-height: 2;font-size: 16px">在首次使用前，建议查看新手引导，以免无从下手。<br>强烈建议收藏此文档！！！
      </div>
      <div class=" text-xs	mt-4 pointer" style="font-size: 16px" @click="clickAgree">
        <a-checkbox v-model:checked="known" class="mr-2"></a-checkbox>
        已阅读<span class="pointer" style="color: rgba(80, 139, 254, 1);"
                    @click.stop="openAgree">《磐古跨链客户端新手引导》</span></div>
      <div class="h-1/5 w-2/5 rounded-lg flex justify-center items-center text-white mt-4 pointer"
           style="background: rgba(42, 42, 42, 1);" @click="next">开始
      </div>
    </div>
    <div v-else
      ...
      <div class="mt-4 text-xs" style="line-height: 2;font-size: 16px">产品功能较多，很难短期内全部了解。<br/>故设置了阶梯式的功能解锁。<br>点击按钮，了解各个等级权益和升级规则。
      </div>
      ...
      <!--    </div>-->
      <div class="rounded-lg h-8 w-5/12 flex justify-center items-center mt-4 pointer"
