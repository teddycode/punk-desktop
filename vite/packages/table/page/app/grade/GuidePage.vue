<template>
  <div v-if="showModal === false" class="flex flex-col h-full items-center justify-between p-5">
    ...
    <div v-if="isShow === false" class="guide-button">
      <div
        class="flex guide-page-bg button-active pointer w-12 h-12 rounded-lg items-center justify-center"
        @click="backSplash"
      >
        ...
        <div class="flex flex-col items-center">
          <div class="flex flex-col items-center mb-8">
            ...
            <span class="secondary-title"
              >完成选择后，会内置对应模式的功能方案，你仍然可以在后续自定义修改各个功能和布局。</span
            >
          </div>
      ...
      <template v-if="step === 2">
        <div class="w-full flex flex-col items-center justify-center">
          <div class="flex flex-col items-center justify-center mb-8 min-mb">
            ...
            <span class="secondary-title">同步社交网络互动功能，完成选择后，你仍然可以在后续自定义修改。</span>
          </div>
          <div class="flex">
            ...
            <div class="flex flex-col">
              ...
              >
                ...
                <span :style="{ background: !simple ? 'green' : 'red' }" class="p-2 rounded-lg px-3">
                  <icon
                    style="font-size: 18px; color: white; vertical-align: middle"
                    v-if="!simple"
                    icon="yixuan"
                  ></icon>
    ...
    <div class="flex">
      <xt-button
        class="mr-10 w-40 h-12 rounded-lg"
    ...
    <div class="guide-page-bg h-full flex items-center justify-center" v-if="showModal === true">
      <div class="rounded-lg flex flex-col p-4" style="width: 480px; background: var(--modal-bg)">
        <div class="flex items-center justify-end">
          <div
            class="w-12 h-12 rounded-lg pointer mouse-click flex items-center justify-center"
