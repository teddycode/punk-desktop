<template>
  ...
  <div class="s-bg p-10 rounded-lg m-3"
    ...
    <div class="line">更新频率（秒）：
      <a-input-number v-model:value="frequent"></a-input-number>
    </div>
    <div class="line">
      使用数据源：
      ...
      <div class="mt-5 s-bg p-3" style="background: var(--primary-bg); border-radius: 8px;">
        ...
        <a-row :gutter="40">
          <a-col>
            ...
            <span class="mb-2" style=" line-height: 1.2"
            >第1步.安装Aida64</span
            >
            ...
            <div class="mt-3 mb-3">
              第2步.进入Aida菜单->文件->设置，如图配置AIDA64并运行，点击查看大图
            </div>
            <div>
              <a-image placeholder="aida" src="/img/aida.jpg" style="width: 200px;border-radius: 4px"></a-image>
            </div>
          </a-col>
          <a-col>
            <div class="line-title">
