<template>
  <div v-if="!activeTask.createTime" style="height: 100%">
    <span class="title-action hover-action flex items-center xt-text pt-3 ml-3" style="cursor: pointer"
      ><!--      @click="toggleMenu"-->
    ...
    <a-empty style="margin-top: calc(100vh / 2 - 130px)" description="点击待办查看详情"> </a-empty>
  </div>
  <div
    v-else
    style="
    ...
    <div style="height: 100%; margin-bottom: 68px" class="flex flex-col">
      <div class="top-bar">
        ...
        <span class="extra-actions">
          ...
          <span class="btn-content" v-else @click="toggleTop"> <to-top-outlined /> 置顶 </span>
      ...
      <div class="detail-box">
        <div class="flex justify-between">
          ...
          <div class="convert-editor btn-style">
            ...
            <a-button type="primary" shape="circle" :bordered="false" v-if="!editing" @click="editing = !editing"
              ><form-outlined />
            </a-button>
            <div class="flex items-center">
              <span class="btn-content" style="background: var(--active-bg)" v-if="editing" @click="saveAndExit">
        ...
        <VueCustomScrollbars :settings="settings" style="position: relative; height: 95%">
          <div
          ...
          <div v-else style="position: relative; padding: 10px 0; height: 100%">
            <template v-if="activeTask.descriptionType.name === 'text'">
              <a-textarea
                style="height: 100%; min-height: 50px; background: #2a2a2a; border-radius: 6px"
            ...
            <template v-show="activeTask.descriptionType === 'markdown'"> markdown </template>
          </div>
        </VueCustomScrollbars>
      </div>
    </div>
