...
<template>
  <div v-if="data?.length === 0" style="margin-left: -20px; margin-top: calc((100vh - 96px) / 2 - 100px)">
        ...
        <div class="h-12 flex items-center px-3">
          ...
          <div style="flex: auto; text-wrap: normal; word-break: break-all; width: 0">
            <div
              ...
              style="word-break: break-all; text-overflow: ellipsis; overflow: hidden; white-space: nowrap"
            >
          ...
          <div>
            <span
              style="margin-left: 5px; white-space: nowrap; word-break-wrap: none; display: inline-block"
              class="dead-time"
              v-if="task.deadTime"
