<template>
  <div style="color: var(--primary-text)">
    ...
    <div style="padding: 1em; width: 30em">
      <div class="line">
        <a-alert
          v-if="!settings.enableBarrage"
          message="目前弹幕功能未开启，请点击下方开关启用。"
          type="warning"
          show-icon
        />
      ...
      <div class="line">
        页面允许渲染弹幕数：<a-input-number
          v-model:value="settings.barrage.limit"
          style="color: var(--primary-text)"
        ></a-input-number>
      </div>
      <div class="line">
        轨道高度：<a-input-number
          v-model:value="settings.barrage.height"
          style="color: var(--primary-text)"
        ></a-input-number>
      </div>
      <div class="line">
        同一个弹幕出现次数：<a-input-number
          v-model:value="settings.barrage.repeat"
          style="color: var(--primary-text)"
        ></a-input-number>
      </div>
      <div class="line">
        弹幕方向：<a-radio-group v-model:value="settings.barrage.direction" style="color: var(--primary-text)"
          ><a-radio value="right" style="color: var(--primary-text)">从右到左</a-radio>
          <a-radio value="left" style="color: var(--primary-text)">从左到右</a-radio></a-radio-group
        >
      </div>
      <div class="line">
