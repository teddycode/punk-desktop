        ...
        <a-row :gutter="20">
            ...
            <div class="mr-3 pointer" style="width: 300px" v-for="source in sources">
              <div @click="this.currentSource = source" class="mb-3 truncate">
                <a-avatar
                  ...
                  v-if="source.type === 'window'"
                  :src="'file://' + source.icon"
                >
                </a-avatar>
                <a-avatar style="width: 20px; height: 20px" shape="square" v-else></a-avatar>
                {{ source.name }}
              </div>
            </div>
          </a-col>
          <a-col :span="12">
            <div>
              预览：
              <div class="mb-4">
                <a-image style="width: 300px; object-fit: contain" :src="'file://' + currentSource.src"> </a-image>
              </div>
            </div>
          </a-col>
        </a-row>
