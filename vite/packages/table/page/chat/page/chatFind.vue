  ...
  <div class="flex flex-col w-full h-full pl-4">
    <div class="flex items-center">
      ...
      <a-input
        ...
        v-if="communityDefault.name === 'community'"
        style="width: 244px; border-radius: 10px; background: var(--secondary-bg)"
        spellcheck="false"
        placeholder="搜索"
        class="h-10 ml-3"
        @pressEnter="findSearch"
        @input="findSearch"
        ref="findSearchRef"
      >
        <template #suffix>
          <SearchIcon
            class="pointer xt-text-2 category-button"
