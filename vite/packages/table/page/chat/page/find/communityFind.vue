      ...
      <div class="flex flex-col">
        ...
        <div class="content-list">
          <div
            ...
            class="category-bg pointer content-item rounded-xl pb-4 mb-4"
          ...
          >
            ...
            <div class="px-4 flex flex-col">
              ...
              <div class="flex mb-3">
                <div
                  class="category-12-400 px-2 rounded-md flex items-center justify-center"
                  style="color: var(--active-bg); background: var(--active-secondary-bg)"
                >
                  社群号:{{ item.no }}
                </div>
                <div
                  class="category-12-400 px-1 rounded-md mx-2 flex items-center justify-center"
                  style="color: var(--warning); background: rgba(250, 173, 20, 0.2)"
                >
                  {{ item.level }}级
                </div>
              </div>
        ...
        <div class="content-list">
          <div
            ...
            class="category-bg pointer content-item pb-4 rounded-xl mb-4"
            style="position: relative"
          >
            <div style="height: 150px; margin-bottom: 30px">
              <img
  ...
  computed: {
    ...
    findList() {
      const list = Object.values(
        this.recommendCommunityList.reduce((acc, curr) => {
          if (!acc[curr.id]) {
            acc[curr.id] = curr;
          }
          return acc;
