<template>
  <div style="height: 100vh" class="xt-modal w-full flex flex-col items-center justify-center">
    <div
      style="width: 600px; height: 601px"
      class="flex items-center box-border flex-col xt-b justify-center rounded-xl xt-bg-2"
    >
      <div class="flex items-center flex-col justify-center" style="width: 452px">
        ...
        <div class="xt-font xt-text font-24 font-500">磐古官方社群</div>
        ...
        <div class="flex flex-col mb-6 justify-start" style="width: 480px">
          ...
          <div class="flex items-center mt-3 mb-6 w-full">
            ...
            <xt-button w="84" h="0" class="font-14 font-400 xt-font" style="color: var(--link) !important"
              >《服务条款》</xt-button
            >
            <span class="xt-font xt-text-2 font-14 font-400">和</span>
            <xt-button h="0" w="84" class="font-14 font-400 xt-font" style="color: var(--link) !important"
              >《隐私政策》</xt-button
            >
          </div>
          <div class="flex items-center">
            <xt-button
              w="96"
              h="0"
              class="font-16 font-500 xt-font"
...
.box-border {
  box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.2), 0px 0px 20px 0px rgba(0, 0, 0, 0.1),
