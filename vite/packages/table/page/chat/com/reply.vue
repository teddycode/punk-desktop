<template>
  <div class="flex items-center justify-between w-full">
    <!-- {{ userUid}} -->
    <a-avatar :size="32" :src="userInfo.avatar" class="pointer" @click.stop="showCard(userUid, Info)"></a-avatar>
    <!-- <div class="w-full ml-3 "> -->
    <a-input v-model:value="value" bordered="false" class=" xt-bg comment-input btn" placeholder="评论"
      ...
      <tippy :interactive="true" placement="bottom" trigger=" click">
        ...
        <xt-button class="rounded-lg xt-text-2 ml-9 active-btn"
          ...
          <replyIcon icon="fluent:emoji-smile-slight-24-regular"
                     style="font-size: 20px; margin-right: 4px;vertical-align: sub;"></replyIcon>
          表情
        </xt-button>
      </tippy>
