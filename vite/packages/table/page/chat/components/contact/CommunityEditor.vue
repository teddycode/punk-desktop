        ...
        <div class="flex px-6 pb-6 justify-between">
          <div class="flex flex-col" style="width: 320px">
            ...
            <a-input
              ...
              spellcheck="false"
              class="h-12 xt-bg xt-text font-16 font-400 xt-font text-center"
            ...
            <div class="textarea-container">
              <a-textarea
                ...
                :maxLength="maxLength"
                class="xt-text xt-bg font-16 font-400 xt-font"
                spellcheck="false"
              ...
              <div class="h-full xt-bg mb-4 rounded-xl" style="width: 280px">
                ...
                <div class="flex flex-col px-4" style="margin-top: 30px">
                  ...
                  <div class="flex" style="padding: 14px 0 15px 0">
                    ...
                    <span
                      class="rounded-md"
                      style="padding: 3px 5px; background: rgb(250, 173, 20, 0.2); color: rgb(250, 173, 20)"
                    >
                      {{ content.level }}级
                    </span>
                  </div>
