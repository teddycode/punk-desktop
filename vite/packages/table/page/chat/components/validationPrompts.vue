<template>
  <div class="flex flex-col" style="width: 500px;height: 320px;">
    ...
    <div class="flex px-6 flex-col mb-6">
      <span v-if="validateObj.joinOption  === 'FreeAccess'"
            class="p-4 font-16-400 rounded-lg mb-4"
            style="width:452px;color:var(--secondary-text);background: var(--secondary-bg);">
         暂未加入群聊，点击立即加入即可访问
      </span>
      <span v-if="validateObj.joinOption  === 'NeedPermission'"
            class="p-4 font-16-400 rounded-lg mb-4"
            style="width:452px;color:var(--secondary-text);background: var(--secondary-bg);">
      ...
      <div class="flex items-center p-4 rounded-lg" style="width:452px;background: var(--secondary-bg);">
        <a-avatar :src="validateObj.avatar" shape="square" size="48"></a-avatar>
    ...
    <div class="flex px-6 items-center justify-center">
      ...
      <XtButton v-if="validateObj.joinOption  === 'FreeAccess'" class="ml-3"
      ...
      <XtButton v-if="validateObj.joinOption  === 'NeedPermission'" class="ml-3"
                style="width: 96px;background: var(--active-bg);color:var(--active-text);"
                @click="joinNow"
      >
        立即申请
