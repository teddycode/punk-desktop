<template>
  <div
    :style="isDoubleColumn ? { width: '336px', height: '150px' } : { width: '240px', height: '130px' }"
    class="relative"
  >
    ...
    <div class="community-name h-11 w-full com-line-bg">
      <div class="m-1.5 px-3 items-center drop-hover rounded-lg flex justify-between h-8">
        <ChatDropDown
          class="w-full"
          newIcon="fluent:line-horizontal-3-20-filled"
  ...
  <div :style="settings.enableHide ? { height: '450px' } : {}">
    <div
      class="px-3 h-full flex flex-col justify-between my-2"
      :style="isDoubleColumn ? { width: '336px' } : { width: '240px' }"
    >
      <!-- 双列 -->
      <template v-if="isDoubleColumn">
        ...
        <div class="w-full flex items-center justify-start">
          <div
            class="px-2 py-1 font-12 rounded-md font-400 xt-font xt-text-2 mb-2"
            :class="settings.enableHide ? '' : 'xt-bg'"
            style="width: 120px"
          >
            社群号：{{ categoryList.no }}
          </div>
      ...
      <template v-else>
        ...
        <div class="flex items-center mt-2">
          <span
            class="px-2 py-1 font-12 rounded-md font-400 xt-font xt-text-2 mr-3"
            :class="settings.enableHide ? '' : 'xt-bg'"
          >
            社群号：{{ categoryList.no }}
          </span>
        ...
        <template v-if="!isDoubleColumn">
          <div class="flex flex-col" :class="channelList.length !== 0 ? 'mb-3' : 'm-0'">
            <div
              ...
              class="flex items-center px-3.5 py-2.5 rounded-lg pointer group-item"
            >
    ...
    return {
      ...
      hideList: [
        ...
        },
        {
          ...
          title: '添加新应用',
          callBack: () => {
            this.$refs.addCategoryRef.openAddNewCategory();
          },
        },
        {
          ...
          title: '添加新分组',
          callBack: () => {
            this.$refs.addNewRef.openAddModal();
          },
        },
        {
          newIcon: 'fluent:text-indent-decrease-16-filled',
          title: '展开边栏',
          callBack: () => {
