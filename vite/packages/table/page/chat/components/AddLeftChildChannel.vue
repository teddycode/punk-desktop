<template>
  ...
  <ChannelLink v-if="selectIndex === 'link' && nextShow === true" :id="id" :no="no" @back="nextShow = false"
               @close="closeChannel"/>
  <ForumChannel v-if="selectIndex === 'community' && nextShow === true" :id="id" :no="no" @back="nextShow = false"
                @close="closeChannel"/>
  <ChannelGroup v-if="selectIndex === 'group' && nextShow === true" :id="id" :no="no" @back="nextShow = false"
                @close="closeChannel"/>
</template>
