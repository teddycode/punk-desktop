<template>
  <div v-if="isNextShow === false" class="flex flex-col" style="padding: 12px; width: 650px; height: 530px;">
    ...
    <div class="top-close" style="margin-bottom: 16px;">
      ...
      <div class="font-16 flex items-center justify-center" style="color:var(--primary-text);width: 95%;">选择联系人
      </div>
      <div class="flex rounded-lg active-button pointer items-center w-12 h-12 justify-center"
    ...
    <div class="flex  justify-between">
      ...
      <div class="right-group">
        ...
        <div class="flex justify-end" style="height: 48px;">
          <div class="flex items-center rounded-md pointer font-16 active-button justify-center"
  ...
  <div v-else-if="classShow === false" class="flex flex-col" style="padding: 12px; width: 650px; height: 530px;">
    ...
    <div class="flex flex-col items-center justify-center"
      ...
      <div v-if="validateChinese" :style="validateChinese === true ? {marginBottom:'16px'}: {marginBottom:'0'}"
           class="font-12" style="color:var(--error);">
        群ID不能为中文名称,重新输入群ID
      </div>
    ...
    <div class="flex justify-end">
      ...
      <a-button style="width: 100px;height: 44px;margin-left: 16px;border-radius: 8px;" type="primary" @click="submit">
        确定
      </a-button>
    </div>
  </div>

  <ChannelClassification v-else :data="groupData" :no="no" type="group" @classBack="classShow = false"
                         @close="closeContact"/>
</template>
