<template>
  ...
  <CreateCommunity v-if="listIndex === 'create' && chatShow === true " id="chat" :no="no" @back="chatShow = false"
                   @close="closeChannel">
  </CreateCommunity>

  <SelectKnownGroup v-if="listIndex === 'already' && chatShow === true" id="contact" :no="no" :type="type"
                    @back="chatShow = false" @close="closeChannel">
  </SelectKnownGroup>
