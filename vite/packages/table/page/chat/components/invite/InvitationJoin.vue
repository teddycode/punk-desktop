<template>
  <div class="flex flex-col mb-4" style="width: 667px; height: 594px">
    <div class="flex items-center justify-center" style="position: relative; line-height: 64px">
      <div
        class="back-button w-10 h-10 pointer rounded-lg category-button flex items-center justify-center"
        @click="backButton"
      >
      ...
      <div
        class="close-button w-10 h-10 pointer rounded-lg category-button flex items-center justify-center"
        @click="closeButton"
      >
