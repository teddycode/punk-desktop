    ...
    <Modal v-model:visible="addVisible" v-if="addVisible" :blurFlag="true" style="z-index: 200 !important">
      <div class="flex flex-col my-3" style="width: 500px" v-if="inviteShow === false">
        ...
        <div class="px-6 flex flex-col">
          <div
            class="p-4 xt-bg-2 rounded-md flex flex-col pointer mb-4"
      ...
      <AddDirectly
        v-else-if="inviteShow === true && type === 'direct'"
        :no="no"
        @close="addVisible = false"
        @back="inviteShow = false"
      />
      <InvitationJoin
        v-else-if="inviteShow == true && type === 'invite'"
        :no="no"
        @close="addVisible = false"
        @back="inviteShow = false"
      />
