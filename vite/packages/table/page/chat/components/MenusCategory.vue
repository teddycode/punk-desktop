<template>
  ...
  <SelectMenuWebLink v-else-if="selectIndex === 'link'" :no="no" type="link" @back="nextShow=false"
                     @close="closeChannel"></SelectMenuWebLink>
  <SelectGroupChat v-else-if="selectIndex === 'chat'" :no="no" type="group" @back="nextShow=false"
                   @close="closeChannel"></SelectGroupChat>
  <ChannelCommunity v-else-if="selectIndex === 'community'" :no="no" @back="nextShow=false"
                    @close="closeChannel"></ChannelCommunity>
</template>
