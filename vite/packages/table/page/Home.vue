<template>
  ...
  <transition name="fade">
    <div class="" style="position: fixed; top: 0; right: 0; left: 0; bottom: 0; z-index: 999" v-if="iconVisible">
...
export default {
  ...
  computed: {
    ...
    ...mapWritableState(cardStore, ['customComponents', 'clockEvent', 'settings', 'desks', 'moved', 'lastHeight']),
