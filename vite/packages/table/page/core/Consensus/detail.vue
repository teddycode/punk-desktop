        ...
        <a-col :span="12">
          <div>
            <a-card title="PoT区块" size="small">
              ...
              />
              <a-input-search placeholder="区块Hash" style="width: 30%" v-model:value="potSearchHash" />
              ...
              <a-table :columns="potColumns" :data-source="potData" :rowKey="(record) => record.id">
        ...
        <a-col :span="12">
          <div>
            <a-card title="业务区块" size="small">
              ...
              />
              <a-input-search placeholder="区块Hash" style="width: 30%" v-model:value="businessSearchHash" />
              ...
              <a-table :columns="businessColumns" :data-source="businessData" :rowKey="(record) => record.id">
                <template #bodyCell="{ column, record }">
                  <template v-if="column.dataIndex === 'action'">
