<template>
  <a-layout style="background-color: #f5f5f5">
    <a-card size="default" title="共识信息" :bordered="true">
      <a-card-meta :title="'基础数据'">
        <template #extra>
      ...
      <a-card-body>
        <a-row :gutter="16">
          <a-col :span="4">
            <a-statistic title="PoT区块数" :value="potBlockCount" />
          </a-col>
          <a-col :span="4">
            <a-statistic title="业务区块数" :value="businessBlockCount" />
          </a-col>
          <a-col :span="4">
...
export default {
  setup() {
    ...
    onMounted(async () => {
      ...
      businessDataBackup.value = micBlockData;
      businessData.value = micBlockData;
