    ...
    <a-dropdown :trigger="['click']" v-model:visible="viewFlag">
      ...
      <template #overlay>
        ...
        >
          ...
          <div class="color-Box">
            <div class="color-Bottom" style="background: #f60; color: #fff" @click="viewFlag = false">关闭</div>
            <div class="color-Bottom" style="background: aqua" @click="Reset">默认</div>
            <div class="color-Bottom" @click="checkedColor">确定</div>
          </div>
        </div>
      </template>
    </a-dropdown>
