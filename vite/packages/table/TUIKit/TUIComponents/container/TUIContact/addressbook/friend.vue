<template>
  <div class="flex flex-col h-full w-full">
    ...
    <div style="color: var(--primary-text);height:100%;">
      <vue-custom-scrollbar :settings="settingsScroller">
        <div v-for="item in list" class="flex list-hover rounded-lg items-center pointer" style="padding: 14px 15px;"
  ...
  <teleport to='body'>
    <FriendModal v-if="friendShow" v-model:visible="friendShow" :blurFlag="true">
