<template>
  <div class="h-full w-full flex flex-col">
    <div class="flex items-center justify-between" style="margin-bottom: 14px">
      ...
      <div
        class="w-11 h-11 rounded-lg flex pointer items-center active-button justify-center"
    ...
    <div style="color: var(--primary-text); height: 100%">
      <vue-custom-scrollbar :settings="settingsScroller">
        <div
          v-for="item in list"
          class="flex items-center rounded-lg list-hover pointer"
...
export default defineComponent({
  ...
  setup() {
    ...
    const clickGroupList = async (item) => {
      // 点击群聊列表
      data.groupShow = true;
