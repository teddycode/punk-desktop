<template>
  <div class="h-full w-full flex flex-col">
    <div class="flex items-center justify-between" style="margin-bottom: 14px;">
      ...
      <div class="w-11 h-11 rounded-lg flex pointer items-center active-button justify-center"
           style="background: var(--active-bg);" @click="clickSearch">
    ...
    <div style="color: var(--primary-text);height:100%;">
      <vue-custom-scrollbar :settings="settingsScroller">
        <div v-for="item in list" class="flex items-center rounded-lg list-hover pointer" style="padding: 14px 15px;"
  ...
  <a-drawer v-model:visible="groupShow" :footer="null" placement="right" width="500">
    <GroupDetail :group="groupItem" :memeber="memeber" @closeDrawer="groupShow = false"></GroupDetail>
  </a-drawer>

  <teleport to='body'>
    <Modal v-if="groupVisible" v-model:visible="groupVisible" :blurFlag="true">
