<template>
  <div
    ...
    class="flex rounded-lg items-center"
  >
  ...
  <div class="rounded-lg flex flex-col" style="background: var(--secondary-bg); margin-bottom: 16px">
    <div class="flex items-center justify-between py-3 px-4">
      ...
      <div class="flex items-center">
        ...
        <Icon
          icon="icon_copy"
          style="color: var(--secondary-text); font-size: 1.5em; cursor: pointer"
  ...
  <div class="flex" v-if="group?.selfInfo?.role !== 'Member'">
    <div
      class="flex items-center pointer justify-center active-button rounded-lg mr-3 h-12 font-16"
    ...
    <div
      class="flex items-center pointer rounded-lg justify-center active-button h-12 font-16"
