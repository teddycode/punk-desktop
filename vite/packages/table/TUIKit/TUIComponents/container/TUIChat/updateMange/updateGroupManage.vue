<template>
  <div class="flex flex-col">
    ...
    <div v-if="groupManageInfo.conversation.type !== 'Private'" class="rounded-lg px-4 py-3 flex flex-col font-14 mb-4"
      ...
      <div class="flex  items-center mt-3">
        ...
        <!-- 添加和删除群管理员按钮 -->
        <div v-if="groupManageInfo.role !== 'Member'" class="flex">
          ...
          <div class="flex pointer items-center justify-center active-button rounded-lg"
               style="width: 32px; height: 32px; background: rgba(255,77,79,0.2);" @click="addAdmin('delAdmin')">
    ...
    <div class="rounded-lg px-4 flex flex-col py-3 font-14" style="width: 468px;background: var(--secondary-bg);">
      ...
      <div class="flex items-center">
        ...
        <div v-if="groupManageInfo.role !== 'Member' " class="flex">
          ...
          <div class="flex pointer items-center justify-center active-button rounded-lg"
               style="width: 32px; height: 32px; background: rgba(255,77,79,0.2);" @click="addMute('removeMuteUser')">
            <Icon icon="jinzhi-yin" style="color: var(--error);font-size: 1.25em;"></Icon>
          </div>
        </div>
      </div>
