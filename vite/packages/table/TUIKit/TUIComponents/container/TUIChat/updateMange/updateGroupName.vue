  ...
  <div class="flex items-center flex-col" style="color: var(--primary-text)">
    <template v-if="isAdmin">
      ...
      <a-input
        ...
        ref="groupRef"
        :spellcheck="false"
        style="color: var(--primary-text); text-align: center; border-radius: 12px !important"
      ></a-input>
    ...
    <template v-else>
      <div class="flex flex-col w-full items-center justify-center">
        ...
        <a-input
          v-model:value="info.groupName"
          :spellcheck="false"
          :disabled="true"
          style="margin-top: 12px; color: var(--primary-text); border-radius: 12px !important; text-align: center"
        ></a-input>
      </div>
    </template>
  </div>
  ...
  watch: {
    info: {
      handler(newVal) {
        ...
        (this.avatar = newVal.avatar), (this.groupName = newVal.groupName);
      },
      immediate: true,
      deep: true,
    },
