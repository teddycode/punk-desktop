  ...
  <div class="flex items-center flex-col" style="color: var(--primary-text);">
    ...
    <template v-else>
      <div class="flex flex-col w-full items-center justify-center">
        <a-avatar :size="64" :src="info.avatar" shape="square"></a-avatar>
        <a-input v-model:value="info.groupName" :disabled="true" :spellcheck="false"
                 style="margin-top: 12px;color: var(--primary-text);border-radius: 12px !important;text-align: center;"></a-input>
      </div>
    </template>
