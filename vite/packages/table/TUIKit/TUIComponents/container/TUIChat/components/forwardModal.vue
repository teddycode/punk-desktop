  ...
  <div class="flex flex-col rounded-lg" style="padding:12px; width:650px;height:534px;background: var(--modal-bg);">
    ...
    <div class="flex-grow flex justify-between w-full px-1">
      <div class="flex flex-col" style="width: 293px;">
        <a-input v-model:value="forwardText" :allowClear="true" class="h-11" placeholder="搜索好友、群聊"
                 style="color:var(--secondary-text);" @change="search($event)" @pressEnter="enterSearch($event)">
          <template #suffix>
      ...
      <div class="flex flex-col" style="width: 293px;">
        ...
        <div class="flex justify-end  h-12">
          <div class="flex items-center">
            ...
            <a-button class="ml-4 rounded-lg" style="width:100px;height: 44px;color:var(--active-text);" type="primary"
                      @click="forwardSend">转发
            </a-button>
          </div>
        </div>
      </div>
