<template>
  <!-- 可拖拽元素 -->
  <div ref="draggable" class="draggable" @click="handleClick" @mousedown="handleMouseDown" @mouseup="handleMouseUp">
    <slot></slot>
  </div>
  <teleport to="body">
    <!-- 拖拽元素 -->
    <div v-show="isDragging" class="follow-container">
      <div
        ref="follow"
        :style="{
          transform: `translate(${followPosition.x - followWidth / 2}px, ${followPosition.y - followHeight / 2}px)`,
