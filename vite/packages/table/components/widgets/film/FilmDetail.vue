    ...
    <div v-else>
      <div v-if="pageToggle" class="flex" style="margin-top: 13px;color: var(--primary-text);">
        <div v-if="fatherWidth == 2" class="cursor-pointer" style="width: 240px;height: 354px;margin: 0 16px 0 5px;">
          <a-image :src="detailMovie.img" alt="" class="rounded-lg" height="354px" style="object-fit: cover;"
                   width="240px"/>
        </div>
        <div :class="fatherWidth == 2 ? 'size-max' : 'size-min'">
          <div style="height:304px;">
            <div :class="fatherWidth == 2 ? 'size-max' : 'size-min'" class="film-content">
              <div
                  style="font-family: PingFangSC-Semibold;font-size: 20px;color: var(--primary-text);font-weight: 600;margin-bottom: 8px;">
                {{ detailMovie.nm }}
              </div>
            ...
            <div v-if="detailMovie.sc" :class="fatherWidth == 2 ? 'size-max' : 'size-min'"
                 class="items-center s-item mt-2 mb-3 rounded-lg pl-4" style="display:flex;height:55px;">
              <span v-if="fatherWidth == 2" class="mr-4"
                    style="font-size: 16px;color: var(--secondary-text);">猫眼</span>
              <span style="font-size: 32px;color: #FFFFFF;letter-spacing: 4px;font-weight: 500;margin-right: 11px;">{{
                  detailMovie.score
                }}</span>
          ...
          <div class="flex items-center justify-between">
            ...
            <span :style="fatherWidth == 2 ? 'padding: 13px 80px;' : 'padding:13px 62px;'"
