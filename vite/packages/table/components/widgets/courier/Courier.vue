    ...
    <div style="position: absolute; top: 14px; left: 120px">
      <xt-button :w="22" :h="22" @click="refreshAll" style="background-color: transparent !important">
        <div class="flex items-center justify-center">
          <newIcon
            class="xt-text refresh"
            style="font-size: 18px; margin-top: 1px; vertical-align: sub"
      ...
      <div class="flex-1 w-full h-0 courier" style="position: relative">
        ...
        <template v-else>
          <div v-if="showWay">
            ...
            <MinCourierItem v-else :courier="displayList[0]" @click.stop="showDetail(displayList[0])"> </MinCourierItem>
          </div>
          <template v-else>
        ...
        <teleport to="body">
          <xt-old-modal
            v-if="courierModalVisible"
            v-model:visible="courierModalVisible"
            title=""
            :isFooter="false"
            zIndex="9"
            :isHeader="false"
          ...
          >
            <LargeCourierDetail
              ...
              :route="showCourierDetail ? 'detail' : 'list'"
              :mode="modalMode"
              @close="
