      ...
      <div class="flex flex-col" style="width: 500px; height: 250px">
        ...
        <div class="mb-4 px-6 flex flex-col">
          <div class="flex items-center mb-4">
            <div
              class="flex items-center mr-3 justify-center rounded-lg w-14 h-14 pointer category-button"
              @click="onUpdateImg"
            >
            ...
            <GoodIcon
              :default-avatar="order.store ? order.content?.items[0].cover : ''"
              v-show="goodIconVisible"
              :goodVisible="false"
            ...
            <a-input
              ...
              style="width: 383px; border-radius: 8px"
            ></a-input>
          </div>
          <div class="flex" v-if="!order.store">
            <a-input
              ref="codeRef"
              class="xt-bg-2"
              v-model:value="form.logisticCode"
              placeholder="快递单号"
              style="width: 188px; border-radius: 8px; margin-right: 12px"
            ></a-input>
            <a-input
              v-if="form.shipperCode === 'SF' || form.shipperCode === 'CNCY'"
              class="xt-bg-2"
            ...
            ></a-input>
            <a-select
              class="custom-select xt-text-2"
              v-model:value="form.shipperCode"
              placeholder="自动识别"
          ...
          <div v-else class="text-center xt-text-2">商城订单不支持修改订单快递单号</div>
        </div>

        <div class="px-4 flex justify-end">
          <xt-button w="64" h="40" class="mr-3" style="border-radius: 8px" @click="editVisible = false"
            >取消
          </xt-button>
