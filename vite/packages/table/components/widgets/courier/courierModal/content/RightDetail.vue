  ...
  <div class="w-full flex flex-col h-full" v-if="emptyObj">
    ...
    <template v-if="detail.store">
      <div class="flex flex-col xt-bg-2 px-3 mb-4 py-2.5 rounded-md">
        <div class="flex justify-between w-full">
          <span class="xt-text font-14 font-400" style="max-width: 100%">{{ detail.title }}</span>
        ...
        <template v-if="detailVisible">
          ...
          <div class="flex w-full">
            <span class="xt-text-2 font-14 font-400"> 订单编号：{{ content?.id }} </span>
    ...
    <div class="px-4 rounded-lg xt-bg-2 flex-1 h-0">
      <template v-if="!detail.store">
        ...
        <vue-custom-scrollbar class="h-full" :settings="settingsScroller" v-else>
