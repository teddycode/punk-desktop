<template>
  <div
    ...
    class="flex flex-col"
    style=""
    :style="mode === 'small' ? 'width:580px;height:700px' : 'width: 976px;height: 600px;'"
  >
    ...
    <template v-else>
      ...
      <div class="flex w-full justify-between px-6 flex-1 h-0">
        <div
          :class="{ 'w-1/2': mode === 'large', 'w-full': mode === 'small' }"
          class="flex flex-col h-full"
          v-if="route === 'list' || mode === 'large'"
        >
          <div class="flex items-center mb-4 justify-between">
            ...
            <div class="flex" v-if="findVisible">
              ...
              <xt-button
                ...
                h="40"
              >
                <CloseOutlined style="font-size: 1.1em"
              /></xt-button>
            </div>
          ...
          <div class="flex flex-col mr-4 h-0 flex-1 w-full">
            <vue-custom-scrollbar :settings="settingsScroller" class="h-full">
              <ListItem
                ...
                @afterRemove="
                  (item) => {
                    this.afterRemove(item, index);
                  }
                "
                @scrollToCurrent="scrollToItem(currentDetail._id)"
                :item="item"
        ...
        <div
          style=""
          :style="{ width: mode === 'small' ? '100%' : '452px' }"
          class="h-full"
          v-if="route === 'detail' || mode === 'large'"
        >
          <div class="left-back">
...
export default {
  ...
  methods: {
    ...
    async showItem(item) {
      ...
      this.detailList.splice(
        this.detailList.findIndex((i) => {
