    ...
    <div class="flex flex-col px-6">
      ...
      <div class="flex flex-col xt-bg-2 px-3 mb-4 py-2.5 rounded-md">
        <div class="flex justify-between w-full">
          <span class="summary xt-text font-14 font-400" style="max-width: 335px"
            >IKEA宜家弗瑞顿转角沙发床带储物坐卧两用客厅简约</span
          >
        ...
        <template v-if="detailVisible">
          ...
          <div class="flex w-full mb-2">
            <span class="xt-text-2 font-14 font-400"> 订单编号：{{ orderNums }} </span>
      ...
      <div class="px-4 rounded-lg xt-bg-2">
        <vue-custom-scrollbar
          ...
          :style="detailVisible ? { height: '228px' } : { height: '291px' }"
        >
          <div class="flex items-center justify-center">
