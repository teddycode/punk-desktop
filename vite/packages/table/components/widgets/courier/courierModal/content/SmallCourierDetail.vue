              ...
              <xt-menu name="name" @contextmenu="revID = { item, index }" :menus="menus">
                ...
                >
                  <div class="flex flex-col items-center">
                    <div class="flex">
                      <div
                        class="flex items-center justify-center mr-3 rounded-lg"
                      ...
                      <div class="flex items-center justify-between" style="width: 362px">
                        <div class="flex flex-col">
                          ...
                          <div class="flex">
                            ...
                            <div
                              v-if="false"
                              class="flex items-center justify-center rounded-md w-6 h-6 xt-text-2 xt-bg"
                            >
                              拆
                            </div>
                          </div>
                        ...
                        <div class="flex flex-col items-center justify-end">
                          <div
                            ...
                            :style="{ background: stateColor(item, index) }"
                          >
                            {{ switchState(item) }}
                          </div>
