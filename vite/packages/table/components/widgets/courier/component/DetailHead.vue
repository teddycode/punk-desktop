  ...
  <div class="flex items-center justify-between mb-3">
    <div class="flex">
      ...
      <div class="flex flex-col ml-3">
        <div class="flex">
          <div
            v-if="orderData.store === 'jd'"
            class="flex items-center rounded-md xt-active-text justify-center w-6 h-6"
            style="background: #e12419"
          >
            JD
          </div>
          <div
            v-if="orderData.store === 'tb'"
            class="flex items-center rounded-md xt-active-text justify-center w-6 h-6"
            style="background: #fa5000"
          >
            淘
          </div>
          <span class="mx-1 xt-font font-16 font-600 xt-text truncate" style="max-width: 200px">{{
            orderData?.title
          }}</span>
        ...
        <div class="flex items-center">
          ...
          <div
            v-if="orderData.content.parentOrderId"
            class="xt-bg-2 w-6 h-6 rounded-md flex items-center justify-center"
          >
            拆
          </div>
        </div>
    ...
    <div class="flex items-center">
      <xt-button @click="toggleFollow" w="32" h="32" style="border-radius: 8px">
        <div class="flex items-center justify-center" v-if="!orderData.followed">
