      ...
      let menus = [
            ...
            },
        {
          ...
          callBack: () => {
            Modal.confirm({
              content:
                '确认删除订单？删除的订单在下次同步的时候仍然会被添加回列表。如果不希望显示此订单，请使用隐藏功能。',
              centered: true,
              onOk: async () => {
...
<template>
  <xt-menu name="name" :menus="menus">
    <div
      ref="itemRef"
      :class="{ select: this.currentDetail?._id === item._id, 'xt-bg-2': !noBg, 'mb-3': !noBg }"
      ...
      <div class="flex">
        ...
        <div class="flex items-center justify-between flex-1 w-0">
            ...
            <div class="flex items-center mb-1.5">
              ...
              <div class="xt-font font-14 font-600 mx-1.5 flex-1 w-0 flex mt-1" style="width: calc(100% - 70px)">
                ...
                <span class="fav-icon ml-1">
                  ...
                  <SmallIcon icon="fluent:star-16-filled" v-else style="color: var(--warning)"
                /></span>
              </div>
            </div>
            <div class="flex">
              ...
              <div
                class="flex items-center pl-1 pr-1 mr-2 rounded-md xt-bg xt-text-2"
          ...
          <div class="flex flex-col items-center justify-end">
            <div
              class="flex items-center ml-8 mb-2 pl-1 pr-1 rounded-md state-text"
