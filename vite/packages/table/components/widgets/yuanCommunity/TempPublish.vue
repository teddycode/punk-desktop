<template>
  ...
  >
    <div
      class="w-full pl-4 pr-4"
      :style="{
        height: fullScreen ? `${windowHeight}px` : 'auto',
        width: fullScreen ? `${windoWidth}px` : '500px',
    ...
    >
      ...
      <div class="flex justify-between w-full h-[64px] items-center">
            ...
            >
              ...
              <template #suffixIcon>
                <newIcon
                  ...
                  style="font-size: 20px; margin-top: -2px; margin-left: -8px"
                  class="xt-text"
                ></newIcon>
              </template>
            </a-select>
        ...
        <div class="flex items-center" v-if="props.options.isRightBtn">
          <xt-button
            class="border-0 rounded-md xt-bg-2 pointer"
          ...
          >
            <div class="flex items-center justify-center">
              <newIcon
                ...
                v-if="!fullScreen"
                class="text-xl text-center xt-text pointer"
              ></newIcon>
              <newIcon
          ...
          <xt-button
            class="ml-2 border-0 rounded-md xt-bg-2 pointer"
            @click="handleOk"
            style="width: 40px; height: 40px; flex-shrink: 0"
          >
            <div class="flex items-center justify-center">
      ...
      >
        ...
        <div class="h-[45px] flex items-center justify-between">
          <div class="flex items-center justify-center xt-text-2">
            <tippy trigger=" click" placement="bottom" :interactive="true">
              ...
              <!-- <button>表情</button> -->
              <xt-button type="text" class="xt-text" :w="72" :h="32" style="color: var(--secondary-text) !important">
                <div class="flex items-center justify-center">
                  <newIcon
        ...
        <div class="flex items-center justify-between h-[56px]">
          ...
          <div class="flex items-center">
            <xt-button type="text" class="xt-bg-2" :w="64" :h="40" style="border-radius: 10px" @click="handleOk"
              >取消</xt-button
            >
            <xt-button
              type="primary"
...
const publishPost = async () => {
  if (
    ...
    (dynamicContent.value.imagesList.length > 0 && defaultType.value.value == 'dynamic')
  ) {
    ...
    (postContent.value.imagesList.length > 0 && defaultType.value.value == 'post')
  ) {
