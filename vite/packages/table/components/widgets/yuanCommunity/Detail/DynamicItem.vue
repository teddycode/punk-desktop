  ...
  <div class="w-full mt-2 xt-bg box font-16">
    <div style="font-size: 1rem !important;">
      <div class="mt-3 mb-2 xt-bg-2 reply-textarea " style="border: 1px solid var(--divider);">
        <!-- 动态和视频 -->
        <a-textarea v-model:value="postValue" :autoSize="{ minRows: 5, maxRows: 8 }"
                    :bordered="false" placeholder=" 请输入"/>
        <!-- 动态和帖子 -->
        <div v-if="imageLoadVisible" style="font-size: 16px !important;">
          <a-upload v-model:file-list="fileList" action="" class="ml-2 text-base" list-type="picture-card"
            ...
            <div v-if="fileList.length < 6">
              ...
              <newIcon class="xt-text" icon="fluent:add-16-filled"
                       style="font-size: 24px;vertical-align: sub;"></newIcon>
            </div>
          </a-upload>
        </div>
  ...
  <div class="h-[45px] flex items-center justify-between ">
    <div class="flex items-center justify-center xt-text-2">
      <tippy :interactive="true" placement="bottom" trigger=" click">
        ...
        <a-button class=" xt-text emojiVis" size="small" style="color: var(--secondary-text) !important;"
                  type="text">
          <template #icon>
            <!-- <SmileOutlined style="" /> -->
      ...
      <a-upload v-model:file-list="fileList" multiple @preview="handlePreview">
        <a-button class="xt-text" size="small" style="color: var(--secondary-text) !important;"
                  type="text">
          <template #icon>
            <newIcon class="text-xl xt-text-2" icon="fluent:image-multiple-16-regular"
                     style="vertical-align: sub;margin-right: 4px;"/>
          </template>
          图片
        </a-button>
