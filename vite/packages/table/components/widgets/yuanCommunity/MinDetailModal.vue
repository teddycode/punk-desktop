<template>
  ...
  >
    <div
      class="w-[600px] h-[700px] maxDetail"
      :style="{
        width: isFullScreen ? `${windoWidth}px` : '600px',
        height: isFullScreen ? `${windowHeight}px` : '700px',
      }"
    >
                  ...
                  <viewer :images="cardData.image_170_170" :options="options" class="items-center p-0 mb-0">
                    <a-row :gutter="[20, 20]" style="margin-right: 1em" wrap="'true">
                      <a-col
                        ...
                        v-for="(img, index) in cardData.image"
                        :span="11"
                        style=""
                      >
                        <img
