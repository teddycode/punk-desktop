<template>
  <Widget ref="eatSlot" :customData="customData" :desk="desk" :menuList="menuList" :options="options">
    <div
      class="truncate"
      style="position: absolute; left: 45px; font-size: 16px; top: 13px; color: var(--primary-text); width: 190px"
    >
      {{ title }}
    </div>
      ...
      menuList: [
        {
          ...
          fn: () => {
            ...
            this.$refs.eatSlot.visible = false;
          },
        },
      ],
      title: '今天吃什么',
