      ...
      <div>
        <div class="cpu right-content">
          <div class="cpu-number">
            <span>温度</span>
            <span style="font-weight: 700">{{ CPUData.warmCPU.value }}℃</span>
          </div>
        </div>
        <a-progress
          :percent="CPUData.warmCPU.value"
          :showInfo="false"
          :status="CPUData.warmCPU.value == 0 || saving ? '' : 'active'"
          :stroke-color="{
            '0%': '#60BFFF',
            '100%': '#348FFF',
          }"
