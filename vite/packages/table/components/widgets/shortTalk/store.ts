        ...
        await post(this.qUrl('/oauth/authorization/getCensus') + '?access_token=' + this.access_token, {
          content: {
            ...
            access: {
              ...
              start:
                customData.defaultTimeType.name == 'day'
                  ? this.getSevenDaysAgoTimestamp()
                  : customData.defaultTimeType.name == 'week'
                  ? this.getSixWeeksAgoMondayTimestamp()
                  : this.getSixMonthsAgoFirstDayTimestamp(),
