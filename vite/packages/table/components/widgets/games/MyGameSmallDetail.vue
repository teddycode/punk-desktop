<template>
  <div v-if="size.width === 1 && size.height === 2">
    <div class="flex flex-col items-center justify-center">
      ...
      <span class="mt-2" style="font-size: 18px; font-weight: 500; margin-bottom: 60px">{{
        detailList[carouselIndex].title
      }}</span>

      <div
        class="rounded-lg flex items-center pointer-active mb-3 s-item pointer justify-center"
      ...
      <div
        v-else
        class="rounded-lg flex items-center pointer-active s-item pointer justify-center"
        style="padding: 13px 80px"
        @click="closeGame"
      >
  ...
  <div v-else>
    <div class="flex mt-2">
      <div class="w-1/2 rounded-lg relative mr-5">
        ...
        <div
          class="detail-name w-full flex items-center rounded-b-lg px-4 py-2"
      ...
      <div class="w-1/2 flex flex-col" style="color: var(--primary-text)">
        ...
        <div
          v-if="isStartGame === false"
          class="flex items-center rounded-lg pointer justify-center px-3 py-3"
