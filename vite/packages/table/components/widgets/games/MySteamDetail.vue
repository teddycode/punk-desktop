  ...
  <div class="mt-3">
    <div v-if="size.width === 2 && size.height === 2" class="flex justify-between justify-center">
      <div class="flex flex-col" style="width:73.53%;">
        <div class=" relative" style="width:400px;height:188px;">
          <img :src="`https://cdn.cloudflare.steamstatic.com/steam/apps/${steamDetail.appid}/header.jpg`" alt=""
        ...
        <div class="flex">
          <div class="flex flex-col">
            ...
            <span class="show-time">M站评分 : {{
                steamDetail.metacritic_score ? steamDetail.metacritic_score : '-'
              }}</span>
          </div>
        ...
        <div class="flex mt-2">
          ...
          <div class="flex  py-3 s-item px-15 detail-active  rounded-lg pointer items-center justify-center"
               style="padding: 13px 40px;"
    ...
    <div v-else class="mt-3 flex flex-col  relative">
      ...
      <div class="flex items-center">
        <div class="flex items-center detail-active mb-2 mr-3 s-item rounded-lg pointer" style="padding: 13px 12px;"
             @click="backGameList">
