...
<template>
  <div v-if="!currentSource.id" style="min-height: 100px">
    <div class="flex flex-col items-center justify-center" style="margin-top: 50px" @click="selectSource">
      <span class="mb-3 s-item w-full pointer my-active btn-active voice-hover text-center rounded-lg py-3"
        ><icon icon="wanggeshitu"></icon> 选择捕获源使用</span
      >
    </div>
  </div>
