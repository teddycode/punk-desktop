      ...
      <div class="flex">
        ...
        <div class="flex-1">
          <div
            ...
            class="flex items-center justify-center px-3 py-3 rounded-full btn-active voice-hover pointer s-item xt-bg-2"
          >
      ...
      >
        <template v-for="(item, index) in outputList">
          <div
            ...
            class="flex items-center w-full py-1 rounded-lg btn-active voice-hover pointer"
    ...
    <div v-else class="mt-4" style="color: var(--primary-text)">
      ...
      <vue-custom-scrollbar class="mt-2" :settings="settingsScroller" style="height: 200px">
        <template v-for="(item, index) in inputList">
          <div
            :class="item.isDefaultForMultimedia ? 's-item xt-bg-2' : ''"
            class="flex items-center w-full px-2 py-1 py-2 rounded-lg voice-hover pointer xt-text"
