  ...
  <Widget :customIndex="customIndex" :customData="customData" :options="options" :desk="desk" :menu-list="menus">
    ...
    >
      <div class="flex">
        ...
        <div class="flex-1">
          <div
            ...
            class="flex items-center justify-center px-3 py-3 rounded-full btn-active voice-hover btn-hover pointer s-item xt-bg-2"
          >
      ...
      <div
        ...
        class="flex items-center justify-center mt-3 rounded-lg btn-active pointer s-item xt-bg-2"
      ...
      <div class="flex">
        ...
        <div
          ...
          style=""
          class="flex items-center justify-center px-3 py-3 rounded-full voice-hover btn-active pointer s-item xt-bg-2"
        >
      ...
      <div
        ...
        class="flex items-center justify-center mt-2 rounded-lg btn-active pointer s-item xt-bg-2"
        style="padding: 8px 10px"
      >
