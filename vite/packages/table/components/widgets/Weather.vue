<template>
  <Widget ref="weatherSlot" :customData="customData" :customIndex="customIndex" :desk="desk" :options="options">
    <div v-if="defaultCity" class="px-3 py-1 bg-mask rounded-xl pointer" style="position: absolute;left: 45px;top:10px"
  ...
  <HorizontalDrawer ref="regionDrawer" v-model:selectRegion="defaultValue" :drawerTitle="drawerTitle"
                    :rightSelect="cities" @getArea="getDefaultWeather"></HorizontalDrawer>
</template>
<script>
