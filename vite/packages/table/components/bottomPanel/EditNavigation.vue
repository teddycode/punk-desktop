        ...
        <div class="box-center">
            ...
            <div v-show="leftNav" id="leftBox" class="side-nav">
              <div class="flex flex-col items-center w-full" style="width: 73px; overflow: hidden">
                <div
                  id="sideNavList"
                  ref="sideContent"
                  class="flex flex-col items-center flex-nowrap scroll-content"
          ...
          <div class="center-text" style="transform: translateY(-20px)">
            <div v-show="navText && !promptModal" class="con-center" style="width: 800px">
              ...
              <div class="mb-2">
                <div class="mb-2 xt-text-2">注意：侧边栏图标风格会自动调整</div>
                <div class="flex mb-2">
            ...
            <div v-show="promptModal" class="prompt-modal">
              <div class="flex flex-col items-center justify-center p-5 xt-modal" style="border-radius: 16px">
                ...
                <span class="my-5"
                  >在导航栏中至少保留一个
                  <span v-for="item in delMainItem" :key="item.name"> 「{{ item.name }}」 </span>
                  入口，以保持功能完整性。</span
                >
                <div class="modal-btn">
        ...
        <div v-show="footNav" id="footBox" class="box-foot">
          <div class="flex flex-row items-center w-full pl-2" style="height: 73px; overflow: hidden">
            <div
              id="navList"
              ref="content"
              class="flex flex-row items-center mr-2 flex-nowrap scroll-content"
              style="overflow: hidden"
            >
    ...
    <transition name="fade">
      <Classification v-if="editFlag" v-model:show="editFlag" :navClassify="navClassify" @clickLeftList="clickItem">
        ...
        <div
          ...
          class="flex flex-col items-start h-full text-zinc-500"
        ...
        >
          ...
          >
            <!-- class="add-icon" -->
            <div
              class="flex items-center justify-center w-40 h-12 rounded-lg pointer add-style"
      ...
      Sortable.create(main, {
        ...
        onStart(evt) {
          ...
          that.draggingArea(
            'leftBox',
            evt.oldIndex,
            that.sideNavigationList,
            that.setSideNavigationList,
            that.mainNavigationList,
          );
          that.draggingArea(
            'rightBox',
            evt.oldIndex,
            that.rightNavigationList,
            that.setRightNavigationList,
            that.mainNavigationList,
          );
          that.draggingArea(
            'footBox',
            evt.oldIndex,
            that.footNavigationList,
            that.setFootNavigationList,
            that.mainNavigationList,
          );
        },
      });
