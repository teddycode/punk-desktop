      ...
      <div class="m-3 s-bg rounded-lg p-1" style="background: var(--primary-bg); color: var(--primary-text)">
        ...
        <div class="m-5 ml-6 mt-1 mb-3">
          <a-row :gutter="40">
            <a-col :span="4">
              <a-avatar
                v-if="team.leaderInfo"
                :src="team.leaderInfo.data.userInfo.avatar"
                class="pointer"
                style="border: 1px solid rgba(255, 255, 255, 0.73)"
                @click.stop="showUserCard(team.leaderInfo.data.userInfo.uid, team.leaderInfo.data.userInfo)"
              ></a-avatar>
            </a-col>
            <a-col v-for="member in team.members.data" :span="4">
              <a-avatar
                ...
                class="pointer"
                @click.stop="showUserCard(member.userInfo.uid, member.userInfo)"
              ></a-avatar>
            </a-col>
          </a-row>
        </div>
