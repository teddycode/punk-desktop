<template>
  ...
  <div>
    ...
    <div v-if="listType === 'my'" id="nav" class="head-nav">
    ...
    <div id="navList">
      <!-- 外部小组件的社区列表 -->
      <div v-for="(item, index) in list" :key="item.nanoid" class="box xt-bg-2">
        <div class="box xt-bg-2">
          <div v-if="setCard === 'my'">
            ...
            <a-dropdown :trigger="['click']" :z-index="999999">
              ...
              <template #overlay>
                <a-menu :selected-keys="selectedKeys" class="set-btn" theme="dark">
                  <a-menu-item key="0" class="h-11 mx-3" theme="dark">
                    <div class="btn-style" @click="addNewCard(item)">添加桌面</div>
                  </a-menu-item>
                  <a-menu-item key="1" class="h-11 mx-3" theme="dark">
          ...
          <div v-else-if="setCard === 'tip'" class="add no-drag" @click="showPrompt(item)">
            <div class="icons">
