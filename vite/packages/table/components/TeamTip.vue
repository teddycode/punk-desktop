        ...
        <div>
          <a-row :gutter="20">
            ...
            <a-col>
              ...
              作为队长，创建您的小队，<strong class="text-white">限时抢占小队靓号</strong>，<a @click="more">了解更多</a>
            </a-col>

          </a-row>

          <div class="rounded-lg h-10 w-100 flex justify-center items-center mt-4 pointer relative"
