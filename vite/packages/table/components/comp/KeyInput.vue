<template>
  ...
  <div v-show="listening" :id="'keyListener_' + this.name" style="transform: translateX(-50%) translateY(-50%); position: absolute;width: 40vw;height:40vh;left: 50%;top: 50%;text-align: center;bottom: 0;background: rgba(21,21,21,0.8);border-radius:20px;line-height: 100px;font-size: 28px;z-index: 999"
       tabindex='0/1'>
