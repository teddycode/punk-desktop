  ...
  <a-tabs v-model:activeKey="activeKey">
    ...
    <a-tab-pane key="private" tab="私密">
      ...
      <vue-custom-scrollbar :settings="innerSettings" style="height: 19em">
        <a-row :gutter="[20, 20]">
          <a-col
            v-for="circle in this.privateGroup"
            :span="12"
            class="pointer"
            @click="go('https://s.apps.vip/forum?id=' + circle.id)"
          >
    ...
    <a-tab-pane key="audit" tab="审核中">
      <a-empty v-if="auditGroup.length === 0"> </a-empty>
      <vue-custom-scrollbar :settings="innerSettings" style="height: 19em">
        <a-row :gutter="[20, 20]">
          <a-col
            v-for="circle in this.auditGroup"
            :span="12"
            class="pointer"
            @click="go('https://s.apps.vip/forum?id=' + circle.id)"
          >
