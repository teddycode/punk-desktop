<template>
  <h3 style="color:var(--primary-text)">我的团队
    <a-button class="relative" style="float: right;border-radius: 8px;border: none;" type="primary"
              @click="createGroup">创建团队
      <GradeSmallTip lastPowerType="创建团队" powerType="group"></GradeSmallTip>
    </a-button>
  </h3>
  <a-tabs v-model:activeKey="activeKey">
    <template #rightExtra>
      <a-button style="border-radius: 8px;color:var(--primary-text)" @click="look">寻找圈子</a-button>
    </template>
    ...
    <a-tab-pane key="public" tab="公开">
      <vue-custom-scrollbar :settings="innerSettings" style="height: 19em">
        <a-row :gutter="[20,20]">
          <a-col v-for="circle in this.publicGroup" :span="12" class="pointer"
                 @click="go('https://s.apps.vip/forum?id='+circle.id)">
            <a-row>
              <a-col :span="6">
                <a-avatar :src="circle.logo_src_pc_46" shape="square"></a-avatar>
              </a-col>
              <a-col :span="18">
    ...
    <a-tab-pane key="private" tab="私密">
      ...
      <vue-custom-scrollbar :settings="innerSettings" style="height: 19em">
        <a-row :gutter="[20,20]">
          <a-col v-for="circle in this.privateGroup" :span="12" class="pointer"
                 @click="go('https://s.apps.vip/forum?id='+circle.id)">
            <a-row>
              <a-col :span="6">
                <a-avatar :src="circle.logo_src_pc_46" shape="square"></a-avatar>
    ...
    <a-tab-pane key="audit" tab="审核中">
      ...
      <vue-custom-scrollbar :settings="innerSettings" style="height: 19em">
        <a-row :gutter="[20,20]">
          <a-col v-for="circle in this.auditGroup" :span="12" class="pointer"
                 @click="go('https://s.apps.vip/forum?id='+circle.id)">
            <a-row>
              <a-col :span="6">
                <a-avatar :src="circle.logo_src_pc_46" shape="square"></a-avatar>
