<template>
  ...
  >
    <div
      class="flex flex-col items-center rounded-lg h-56 w-full justify-evenly text-sm text-white"
...
export default {
  ...
  mounted() {
    this.lv = lv;
    const { tipTitle, blocking, powerLv, powerAlias, superiorLimit } = this.powerState(
      this.powerType,
      lv,
      this.lastPowerType,
    );
