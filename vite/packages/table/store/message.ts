...
export const messageStore = defineStore('messageStore', {
  ...
  actions: {
    async getMessageIndex() {
      try {
        let messageResponse = await axios.post(url.messageIndex, {}, await getConfig());
    ...
    async getNewFollower() {
      let messageResponse = await axios.post(url.getNewFollower, {}, await getConfig());
      if (messageResponse.data.code === 1000) {
        if (messageResponse.data.data.code === 200) {
          const comReturn = messageResponse.data.data.data;
    ...
    async getSystemNotice() {
      let messageResponse = await axios.post(url.getSystemNotice, {}, await getConfig());
      if (messageResponse.data.code === 1000) {
        if (messageResponse.data.data.code === 200) {
          const comReturn = messageResponse.data.data.data;
    ...
    async getCustomNotice() {
      let messageResponse = await axios.post(url.getCustomNotice, {}, await getConfig());
      if (messageResponse.data.code === 1000) {
        if (messageResponse.data.data.code === 200) {
          const comReturn = messageResponse.data.data.data;
    ...
    //获得push消息
    async getPush() {
      let messageResponse = await axios.post(url.getPush, {}, await getConfig());
      if (messageResponse.data.code === 1000) {
        if (messageResponse.data.data.code === 200) {
          const comReturn = messageResponse.data.data.data;
          this.push = comReturn;
    ...
    //获得点赞消息
    async getSupport() {
      let messageResponse = await axios.post(url.getSupport, {}, await getConfig());
      if (messageResponse.data.code === 1000) {
        if (messageResponse.data.data.code === 200) {
          const comReturn = messageResponse.data.data.data;
    ...
    //获得@消息
    async getMention() {
      let messageResponse = await axios.post(url.getMentions, {}, await getConfig());
      if (messageResponse.data.code === 1000) {
        if (messageResponse.data.data.code === 200) {
          const comReturn = messageResponse.data.data.data;
    ...
    //获得评论
    async getComment() {
      let messageResponse = await axios.post(url.getComment, {}, await getConfig());
