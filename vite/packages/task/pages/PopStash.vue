...
export default {
  ...
  methods: {
    ...
    importTasks() {
      this.ipc.send('importTasks', {
        ids: JSON.parse(JSON.stringify(this.selectedKeys)),
...
<template>
  <div style="display: flex; flex-direction: column; height: 100vh">
    ...
    <div @click.stop="() => {}" class="bottom-bar">
      <a-checkbox style="margin-right: 10px" v-model:checked="config.removeAfterImported"
        >导入成功后删除已导入的标签组</a-checkbox
      >
