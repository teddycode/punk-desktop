      ...
      <div class="medium-8 columns medium-centered text-center">
        <a href="https://github.com/shipshapecode/shepherd" class="shepherd-logo-link">
          <svg
            ...
            version="1.0"
            style="height: 330px; width: 330px; max-width: 80%"
            viewBox="0 0 128 128"
          >
            <g>
              <path
              ...
              <path
                style="
                  ...
                  fill-rule: evenodd;
                  stroke: #c8c7d5;
                  stroke-width: 2.57602835ffffff10;
                  stroke-linecap: butt;
                  stroke-linejoin: miter;
                  stroke-miterlimit: 4;
                  stroke-opacity: 1;
              ...
              <path
                ...
                transform="matrix(1.4077938,0.63339841,-0.63339841,1.4077938,-19.160477,-48.663084)"
              ></path>
              <path
                transform="matrix(0.55763261,0.25089158,-0.25089158,0.55763261,25.499182,19.393293)"
                d="m 76,48 a 4,4 0 1 1 -8,0 4,4 0 1 1 8,0 z"
                sodipodi:ry="4"
                sodipodi:rx="4"
                sodipodi:cy="48"
              ...
              ></path>
              <path
                transform="matrix(1.4077938,0.63339841,-0.63339841,1.4077938,6.1884772,-48.714859)"
                d="m 76,48 a 4,4 0 1 1 -8,0 4,4 0 1 1 8,0 z"
                sodipodi:ry="4"
                sodipodi:rx="4"
                sodipodi:cy="48"
              ...
              <path
                ...
                sodipodi:ry="4"
                d="m 76,48 a 4,4 0 1 1 -8,0 4,4 0 1 1 8,0 z"
                transform="matrix(0.55763261,0.25089158,-0.25089158,0.55763261,50.848137,19.341517)"
              ></path>
              <path
                sodipodi:nodetypes="cscc"
                id="path3771"
