...
export class ContextMenusAPI {
  private menus = new Map</* extensionId */ string, Map</* menuItemId */ string, ContextItemProps>>();
  ...
  private buildMenuItemsForExtension(extensionId: string, menuType: ContextMenuType): Electron.MenuItem[] {
