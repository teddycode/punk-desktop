...
const getUrgency = (priority?: number): Required<Electron.NotificationConstructorOptions>['urgency'] => {
...
export class NotificationsAPI {
  ...
  private update = ({ extension }: ExtensionEvent, id: string, opts: chrome.notifications.NotificationOptions) => {
    const notificationId = createScopedIdentifier(extension, id);
