  ...
  <MainBackground>
    <div class="signup-page">
      <div class="signup-card">
        ...
        <form autocomplete="off" class="signup-form" @submit.prevent="register">
          <div :class="{ 'input-error': usernameError }" class="form-item">
            <label for="username">用户名</label>
            <div class="input-with-icon">
              <font-awesome-icon class="input-icon" icon="user"/>
              <input id="username" v-model="signupForm.username" placeholder="必填" type="text" @input="checkUsername"/>
            </div>
          </div>
          <div :class="{ 'input-error': passwordError }" class="form-item">
            <label for="password">密码</label>
            <div class="input-with-icon">
              <font-awesome-icon class="input-icon" icon="lock"/>
              <input v-model="signupForm.password" :type="showPassword ? 'text' : 'password'" placeholder="必填"
                     @input="checkPassword"/>
              <font-awesome-icon :icon="showPassword ? 'eye' : 'eye-slash'" class="toggle-icon"
                                 @click="togglePasswordVisibility"/>
            </div>
          </div>
          <div :class="{ 'input-error': confirmPasswordError }" class="form-item">
            <label for="confirmPassword">密码确认</label>
            <div class="input-with-icon">
              <font-awesome-icon class="input-icon" icon="lock"/>
              <input v-model="signupForm.confirmPassword" :type="showConfirmPassword ? 'text' : 'password'"
                     placeholder="必填" @input="checkConfirmPassword"/>
              <font-awesome-icon :icon="showConfirmPassword ? 'eye' : 'eye-slash'" class="toggle-icon"
                                 @click="toggleConfirmPasswordVisibility"/>
            </div>
          </div>
          <div :class="{ 'input-error': emailError }" class="form-item">
            <label for="email">邮箱</label>
            <div class="input-with-icon">
              <font-awesome-icon class="input-icon" icon="envelope"/>
              <input id="email" v-model="signupForm.email" placeholder="必填" type="email" @input="checkEmail"/>
            </div>
          </div>
          <div class="form-item">
