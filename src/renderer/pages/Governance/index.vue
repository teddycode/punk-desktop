      ...
      <div class="content-container">
        ...
        <div class="center-div">
          <div class="nav-container">
            <button class="nav-btn">共识</button>
            <button class="nav-btn">网络</button>
            <button class="nav-btn">公共物品</button>
          ...
          <div class="main-content">
            ...
            <div class="content-box">
              ...
              <div class="box-main-content">
                <img alt="" class="main-img" src="@renderer/assets/images/governance/pos_gov.jpg"
            ...
            <div class="content-box">
              ...
              <div class="box-main-content">
                <img alt="" class="main-img" src="@renderer/assets/images/governance/treasure.jpg">
              </div>
            </div>
...
import myProposals from "@pages/Governance/components/myProposals.vue";
...
.nav-btn:hover {
  background-color: #4FD1C5; /* 当鼠标悬停时的颜色变化 */
}
