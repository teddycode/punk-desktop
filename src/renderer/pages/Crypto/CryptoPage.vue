<template>
  <MainBackground>
    <!-- 导航栏 -->
    <el-menu :default-active="activeIndex" active-text-color="#ffd04b" background-color="#111B2D" class="el-menu-demo"
      ...
      <el-row gutter="40">
        <el-col :span="12">
          <div class="document-button">
            ...
            <font-awesome-icon class="right-icon" icon="angle-right"/>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="document-button">
...
.DeveloperEntrance {
  ...
  background-image: url('@renderer/assets/images/developer-background.jpg'); /* 使用您上传的图片作为背景 */
