        ...
        <div class="main">
            ...
            <form @submit.prevent="submitProposal">
                ...
                <div class="input-group">
                    ...
                    <input class="custom-input" v-model="type" required>
                </div>
                <div class="input-group">
                    <label for="title">执行器</label>
                    <input class="custom-input" v-model="executor" required>
                </div>
                <div class="input-group">
                    <label for="title">目标</label>
                    <input class="custom-input" v-model="target" required>
                </div>
                <div class="input-group">
                    <label for="title">金额</label>
                    <input class="custom-input" v-model="value" required>
                </div>
                <div class="input-group">
                    <label for="title">签名</label>
                    <input class="custom-input" v-model="signature" required>
                </div>
                <div class="input-group">
                    <label for="title">载荷数据</label>
                    <input class="custom-input" v-model="calldata" required>
                </div>
                <div class="input-group">
                    <label for="title">代理调用</label>
                    <input class="custom-input" v-model="withdelgateCall" required>
                </div>
                <div class="input-group">
                    <label for="title">ipfs哈希</label>
                    <input class="custom-input" v-model="ipfsHash" required>
                </div>
