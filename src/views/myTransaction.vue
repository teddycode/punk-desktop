<template>
 <MainBackground> 
        ...
        <div class="header-transaction">
            <router-link to="/myTransaction/myExchange" class="btn-transaction" :class="{active: $route.path === '/myTransaction/myExchange'}">市价</router-link>
            <router-link to="/myTransaction/limitOrder" class="btn-transaction" :class="{active: $route.path === '/myTransaction/limitOrder'}">限价</router-link>
            <router-link to="/myTransaction/depositToken" class="btn-transaction" :class="{active: $route.path === '/myTransaction/depositToken'}">充提</router-link>
            ...
            <router-link to="/myTransaction/myOrder" class="btn-transaction" :class="{active: $route.path === '/myTransaction/myOrder'}">我的订单</router-link>
        </div>
...
import myOrder from "./Transactions/myOrder.vue";
import TokenPage from "./Transactions/myToken.vue";
...
.left-panel {
    ...
    background-image: url('@/assets/leftpic.png');
