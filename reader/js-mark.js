(function (global, factory) {
  ...
  function getTextNodes(node, ignoreClass = [], ignore = false) {
    ...
    for (let i = 0; i < e.length; i++) {
      ...
      if (
        ...
        ((_a = element.parentElement) === null || _a === void 0 ? void 0 : _a.nodeName) !== 'SCRIPT' &&
        ((_b = element.textContent) === null || _b === void 0 ? void 0 : _b.trim()) !== ''
      ) {
  ...
  var acorn = createCommonjsModule(function (module, exports) {
    ...
    var identifierStart =
      '(?:\\\\u[0-9a-fA-F]{4}|[' + baseASCIIidentifierStartChars + nonASCIIidentifierStartChars + '])';
    var identifierChars =
      '(?:\\\\u[0-9a-fA-F]{4}|[' +
  ...
  Tokenizer$3.prototype._is_closing = function (current_token, open_token) {
    return (
      (current_token.type === TOKEN$3.END_BLOCK || current_token.type === TOKEN$3.END_EXPR) &&
      open_token &&
  ...
  Tokenizer$3.prototype._allow_regexp_or_xml = function (previous_token) {
    ...
    return (
      (previous_token.type === TOKEN$3.RESERVED &&
        in_array$2(previous_token.text, ['return', 'case', 'throw', 'else', 'do', 'typeof', 'yield'])) ||
      (previous_token.type === TOKEN$3.END_EXPR &&
        previous_token.text === ')' &&
        previous_token.opened.previous.type === TOKEN$3.RESERVED &&
        in_array$2(previous_token.opened.previous.text, ['if', 'while', 'for'])) ||
  ...
  Beautifier$5.prototype.start_of_statement = function (current_token) {
    var start = false;
    start =
      start || (reserved_array(this._flags.last_token, ['var', 'let', 'const']) && current_token.type === TOKEN$2.WORD);
    ...
    start =
      ...
      (this._flags.last_token.type === TOKEN$2.END_EXPR &&
        (this._previous_flags.mode === MODE.ForInitializer || this._previous_flags.mode === MODE.Conditional));
    start =
      start ||
  ...
  Beautifier$5.prototype.handle_start_block = function (current_token) {
    ...
    if (this._flags.last_word === 'switch' && this._flags.last_token.type === TOKEN$2.END_EXPR) {
      ...
      in_array$1(this._flags.last_token.type, [TOKEN$2.EQUALS, TOKEN$2.START_EXPR, TOKEN$2.COMMA, TOKEN$2.OPERATOR]) ||
    ...
    var empty_anonymous_function =
      empty_braces && this._flags.last_word === 'function' && this._flags.last_token.type === TOKEN$2.END_EXPR;
    ...
    if (
      (this._options.brace_style === 'expand' || (this._options.brace_style === 'none' && current_token.newlines)) &&
      ...
      if (
        ...
        (this._flags.last_token.type === TOKEN$2.START_EXPR || this._flags.last_token.type === TOKEN$2.COMMA)
      ) {
  ...
  Beautifier$5.prototype.handle_word = function (current_token) {
    ...
    if (reserved_array(current_token, ['else', 'catch', 'finally'])) {
      if (
        (!(this._flags.last_token.type === TOKEN$2.END_BLOCK && this._previous_flags.mode === MODE.BlockStatement) ||
          this._options.brace_style === 'expand' ||
          this._options.brace_style === 'end-expand' ||
          (this._options.brace_style === 'none' && current_token.newlines)) &&
        !this._flags.inline_frame
    ...
    if (
      current_token.previous &&
      (current_token.previous.type === TOKEN$2.WORD || current_token.previous.type === TOKEN$2.RESERVED)
    ) {
      this._output.space_before_token = true;
    }
    this.print_token(current_token);
  ...
  Beautifier$5.prototype.handle_string = function (current_token) {
    if (
      ...
      (current_token.previous.text === ')' || this._flags.last_token.type === TOKEN$2.WORD)
    );
      ...
      if (
        ...
        current_token.text.startsWith('`') &&
        this._flags.last_token.type === TOKEN$2.END_EXPR &&
        (current_token.previous.text === ']' || current_token.previous.text === ')') &&
        current_token.newlines === 0
      ) {
        this._output.space_before_token = true;
      } else {
  ...
  Tokenizer$1.prototype._is_content_unformatted = function (tag_name) {
    ...
    return (
      ...
      (this._options.content_unformatted.indexOf(tag_name) !== -1 || this._options.unformatted.indexOf(tag_name) !== -1)
    );
  };
  ...
  function initVTextNodes(textNodes) {
    ...
    for (let i = 0; i < textNodes.length; i++) {
      ...
      if (!text.ignore) offset += text.textContent ? text.textContent.length : 0;
    }
  ...
  function splitVTextNode(text, offset) {
    ...
    if (i !== -1) {
      ...
      const newVText = {
        ...
        offset:
          vTextNodes[i].offset +
          (((_a = vTextNodes[i].text.textContent) === null || _a === void 0 ? void 0 : _a.length) || 0),
      };
