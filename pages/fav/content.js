...
<div  id="_fav-modal" style="box-sizing: content-box;border-radius: 8px;overflow: hidden;display: flex;width: 350px;position: fixed;z-index:999999 !important;left: 400px;top:400px;height: 190px;box-shadow: 0 0 16px rgba(58,58,58,0.22)">
    ...
    <div hidden style="width:150px;background: white;position: relative;font-size: 12px;padding: 10px">
      <div>
        <div>
          <div class="_fav-folder" style="padding: 5px;border-radius: 4px;">文件夹1</div>
          <div class="_fav-folder" style="padding: 5px;border-radius: 4px;">文件夹2</div>
          <div class="_fav-folder" style="padding: 5px;border-radius: 4px;">文件夹3</div>
          <div class="_fav-folder" style="padding: 5px;border-radius: 4px;">文件夹5</div>
        </div>
      </div>
