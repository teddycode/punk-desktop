(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['tsbk'] = factory();
  else root['tsbk'] = factory();
})(this, function () {
  return /******/ (() => {
    // webpackBootstrap
    /******/ 'use strict';
      ...
      _createClass(tsbk, null, [
        {
          ...
          value: function config(options) {
            if (Object.keys(tsbk.secretInfo).length === 0) {
              if (!options || toString.call(options) !== '[object Object]' || Object.keys(options).length === 0)
          ...
          value: function openPermissionWindow(options) {
            return new Promise(function (resolve, reject) {
              ...
              if (
                ...
                !options.hasOwnProperty('bindId') &&
                !options.hasOwnProperty('appName')
              ) {
                reject({
                  code: 400,
                  msg: '参数不全',
